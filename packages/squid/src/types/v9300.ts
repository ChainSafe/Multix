...
export type Type_350 = Type_350_Rebid | Type_350_Reject | Type_350_Approve;

export interface Type_350_Rebid {
  __kind: 'Rebid';
}

export interface Type_350_Reject {
  __kind: 'Reject';
}

export interface Type_350_Approve {
  __kind: 'Approve';
}
...
export type Type_431 = Type_431_V0 | Type_431_V1 | Type_431_V2;

export interface Type_431_V0 {
  __kind: 'V0';
  value: Type_432;
}

export interface Type_431_V1 {
  __kind: 'V1';
  value: Type_437;
}

export interface Type_431_V2 {
  __kind: 'V2';
  value: Type_443[];
}
...
export type Type_307 = Type_307_Xcm | Type_307_Response;

export interface Type_307_Xcm {
  __kind: 'Xcm';
  value: V1MultiLocation;
}

export interface Type_307_Response {
  __kind: 'Response';
  value: V1MultiLocation;
}
...
export type Type_432 =
  ...
  | Type_432_ReserveAssetDeposit
  | Type_432_TeleportAsset
...
export interface Type_432_ReserveAssetDeposit {
  __kind: 'ReserveAssetDeposit';
  assets: V0MultiAsset[];
  effects: Type_434[];
}

export interface Type_432_TeleportAsset {
  __kind: 'TeleportAsset';
  assets: V0MultiAsset[];
  effects: Type_434[];
}
...
export interface Type_434_Null {
  __kind: 'Null';
}
...
export type Type_439 =
  ...
  | Type_439_QueryHolding
  | Type_439_BuyExecution;

export interface Type_439_Noop {
  __kind: 'Noop';
}
