 ...
 * Contains one variant per dispatchable that can be called by an extrinsic.
 */
export type GiltCall =
  | GiltCall_place_bid
  | GiltCall_retract_bid
  | GiltCall_set_target
  | GiltCall_thaw;
...
export type Type_338 = Type_338_Rebid | Type_338_Reject | Type_338_Approve;

export interface Type_338_Rebid {
  __kind: 'Rebid';
}

export interface Type_338_Reject {
  __kind: 'Reject';
}

export interface Type_338_Approve {
  __kind: 'Approve';
}
...
export type Type_417 = Type_417_V0 | Type_417_V1 | Type_417_V2;

export interface Type_417_V0 {
  __kind: 'V0';
  value: Type_418;
}

export interface Type_417_V1 {
  __kind: 'V1';
  value: Type_423;
}

export interface Type_417_V2 {
  __kind: 'V2';
  value: Type_429[];
}
...
export type Type_293 = Type_293_Members | Type_293_Member | Type_293__Phantom;

export interface Type_293_Members {
  __kind: 'Members';
  value: [number, number];
}

export interface Type_293_Member {
  __kind: 'Member';
  value: Uint8Array;
}

export interface Type_293__Phantom {
  __kind: '_Phantom';
}
...
export type Type_295 = Type_295_Xcm | Type_295_Response;

export interface Type_295_Xcm {
  __kind: 'Xcm';
  value: V1MultiLocation;
}

export interface Type_295_Response {
  __kind: 'Response';
  value: V1MultiLocation;
}
...
export type Type_418 =
  | Type_418_WithdrawAsset
  | Type_418_ReserveAssetDeposit
  | Type_418_TeleportAsset
  | Type_418_QueryResponse
  | Type_418_TransferAsset
  | Type_418_TransferReserveAsset
  | Type_418_Transact
  | Type_418_HrmpNewChannelOpenRequest
  | Type_418_HrmpChannelAccepted
  | Type_418_HrmpChannelClosing
  | Type_418_RelayedFrom;

export interface Type_418_WithdrawAsset {
  __kind: 'WithdrawAsset';
  assets: V0MultiAsset[];
  effects: Type_420[];
}

export interface Type_418_ReserveAssetDeposit {
  __kind: 'ReserveAssetDeposit';
  assets: V0MultiAsset[];
  effects: Type_420[];
}

export interface Type_418_TeleportAsset {
  __kind: 'TeleportAsset';
  assets: V0MultiAsset[];
  effects: Type_420[];
}

export interface Type_418_QueryResponse {
  __kind: 'QueryResponse';
  queryId: bigint;
  response: V0Response;
}

export interface Type_418_TransferAsset {
  __kind: 'TransferAsset';
  assets: V0MultiAsset[];
  dest: V0MultiLocation;
}

export interface Type_418_TransferReserveAsset {
  __kind: 'TransferReserveAsset';
  assets: V0MultiAsset[];
  dest: V0MultiLocation;
  effects: V0Order[];
...
export interface Type_418_Transact {
  __kind: 'Transact';
  originType: V0OriginKind;
  requireWeightAtMost: bigint;
  call: DoubleEncoded;
...
export interface Type_418_HrmpNewChannelOpenRequest {
  __kind: 'HrmpNewChannelOpenRequest';
  sender: number;
  maxMessageSize: number;
  maxCapacity: number;
...
export interface Type_418_HrmpChannelAccepted {
  __kind: 'HrmpChannelAccepted';
  recipient: number;
}

export interface Type_418_HrmpChannelClosing {
  __kind: 'HrmpChannelClosing';
  initiator: number;
  sender: number;
  recipient: number;
...
export interface Type_418_RelayedFrom {
  __kind: 'RelayedFrom';
  who: V0MultiLocation;
  message: Type_418;
}

export type Type_423 =
  | Type_423_WithdrawAsset
  | Type_423_ReserveAssetDeposited
  | Type_423_ReceiveTeleportedAsset
  | Type_423_QueryResponse
  | Type_423_TransferAsset
  | Type_423_TransferReserveAsset
  | Type_423_Transact
  | Type_423_HrmpNewChannelOpenRequest
  | Type_423_HrmpChannelAccepted
  | Type_423_HrmpChannelClosing
  | Type_423_RelayedFrom
  | Type_423_SubscribeVersion
  | Type_423_UnsubscribeVersion;

export interface Type_423_WithdrawAsset {
  __kind: 'WithdrawAsset';
  assets: V1MultiAsset[];
  effects: Type_425[];
}

export interface Type_423_ReserveAssetDeposited {
  __kind: 'ReserveAssetDeposited';
  assets: V1MultiAsset[];
  effects: Type_425[];
}

export interface Type_423_ReceiveTeleportedAsset {
  __kind: 'ReceiveTeleportedAsset';
  assets: V1MultiAsset[];
  effects: Type_425[];
}

export interface Type_423_QueryResponse {
  __kind: 'QueryResponse';
  queryId: bigint;
  response: V1Response;
}

export interface Type_423_TransferAsset {
  __kind: 'TransferAsset';
  assets: V1MultiAsset[];
  beneficiary: V1MultiLocation;
}

export interface Type_423_TransferReserveAsset {
  __kind: 'TransferReserveAsset';
  assets: V1MultiAsset[];
  dest: V1MultiLocation;
  effects: V1Order[];
...
export interface Type_423_Transact {
  __kind: 'Transact';
  originType: V0OriginKind;
  requireWeightAtMost: bigint;
  call: DoubleEncoded;
...
export interface Type_423_HrmpNewChannelOpenRequest {
  __kind: 'HrmpNewChannelOpenRequest';
  sender: number;
  maxMessageSize: number;
  maxCapacity: number;
...
export interface Type_423_HrmpChannelAccepted {
  __kind: 'HrmpChannelAccepted';
  recipient: number;
}

export interface Type_423_HrmpChannelClosing {
  __kind: 'HrmpChannelClosing';
  initiator: number;
  sender: number;
  recipient: number;
...
export interface Type_423_RelayedFrom {
  __kind: 'RelayedFrom';
  who: V1Junctions;
  message: Type_423;
}

export interface Type_423_SubscribeVersion {
  __kind: 'SubscribeVersion';
  queryId: bigint;
  maxResponseWeight: bigint;
}

export interface Type_423_UnsubscribeVersion {
  __kind: 'UnsubscribeVersion';
}
...
export type Type_420 =
  | Type_420_Null
  | Type_420_DepositAsset
  | Type_420_DepositReserveAsset
  | Type_420_ExchangeAsset
  | Type_420_InitiateReserveWithdraw
  | Type_420_InitiateTeleport
  | Type_420_QueryHolding
  | Type_420_BuyExecution;

export interface Type_420_Null {
  __kind: 'Null';
}
...
export interface Type_425_QueryHolding {
  __kind: 'QueryHolding';
  queryId: bigint;
  dest: V1MultiLocation;
  assets: V1MultiAssetFilter;
