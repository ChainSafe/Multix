...
export type Call =
  ...
  | Call_BridgeRococoGrandpa
  | Call_BridgeWococoGrandpa
  | Call_BridgeRococoMessages
  | Call_BridgeWococoMessages
  | Call_Collective
  | Call_Membership
  | Call_Utility
  | Call_Proxy
...
export type ConfigurationCall =
  ...
  | ConfigurationCall_set_dispute_max_spam_slots
...
export type RegistrarCall =
  ...
  | RegistrarCall_swap
  | RegistrarCall_force_remove_lock
 ...
 * Contains one variant per dispatchable that can be called by an extrinsic.
 */
export type BridgeRococoGrandpaCall =
  | BridgeRococoGrandpaCall_submit_finality_proof
  | BridgeRococoGrandpaCall_initialize
  | BridgeRococoGrandpaCall_set_owner
  | BridgeRococoGrandpaCall_set_operational;
 ...
 * Contains one variant per dispatchable that can be called by an extrinsic.
 */
export type BridgeWococoGrandpaCall =
  | BridgeWococoGrandpaCall_submit_finality_proof
  | BridgeWococoGrandpaCall_initialize
  | BridgeWococoGrandpaCall_set_owner
  | BridgeWococoGrandpaCall_set_operational;
 ...
 * Contains one variant per dispatchable that can be called by an extrinsic.
 */
export type BridgeRococoMessagesCall =
  | BridgeRococoMessagesCall_set_owner
  | BridgeRococoMessagesCall_set_operating_mode
  | BridgeRococoMessagesCall_update_pallet_parameter
  | BridgeRococoMessagesCall_send_message
  | BridgeRococoMessagesCall_increase_message_fee
  | BridgeRococoMessagesCall_receive_messages_proof
...
export type BridgeWococoMessagesCall =
  ...
  | BridgeWococoMessagesCall_update_pallet_parameter
  | BridgeWococoMessagesCall_send_message
  | BridgeWococoMessagesCall_increase_message_fee
  | BridgeWococoMessagesCall_receive_messages_proof
  | BridgeWococoMessagesCall_receive_messages_delivery_proof;
 ...
 * Contains one variant per dispatchable that can be called by an extrinsic.
 */
export type CollectiveCall =
  | CollectiveCall_set_members
  | CollectiveCall_execute
  | CollectiveCall_propose
  | CollectiveCall_vote
  | CollectiveCall_close
  | CollectiveCall_disapprove_proposal;
 ...
 * Contains one variant per dispatchable that can be called by an extrinsic.
 */
export type MembershipCall =
  | MembershipCall_add_member
  | MembershipCall_remove_member
  | MembershipCall_swap_member
  | MembershipCall_reset_members
  | MembershipCall_change_key
  | MembershipCall_set_prime
  | MembershipCall_clear_prime;
...
export type OperatingMode =
  ...
  | OperatingMode_RejectingOutboundMessages
  | OperatingMode_Halted;
...
export type V0Xcm =
  | V0Xcm_WithdrawAsset
  | V0Xcm_ReserveAssetDeposit
  | V0Xcm_TeleportAsset
  | V0Xcm_QueryResponse
  | V0Xcm_TransferAsset
  | V0Xcm_TransferReserveAsset
  | V0Xcm_Transact
  | V0Xcm_HrmpNewChannelOpenRequest
  | V0Xcm_HrmpChannelAccepted
  | V0Xcm_HrmpChannelClosing
  | V0Xcm_RelayedFrom;
...
export type V1Xcm =
  | V1Xcm_WithdrawAsset
  | V1Xcm_ReserveAssetDeposited
  | V1Xcm_ReceiveTeleportedAsset
  | V1Xcm_QueryResponse
  | V1Xcm_TransferAsset
  | V1Xcm_TransferReserveAsset
  | V1Xcm_Transact
  | V1Xcm_HrmpNewChannelOpenRequest
  | V1Xcm_HrmpChannelAccepted
  | V1Xcm_HrmpChannelClosing
  | V1Xcm_RelayedFrom
  | V1Xcm_SubscribeVersion
  | V1Xcm_UnsubscribeVersion;
...
export type CallOrigin =
  | CallOrigin_SourceRoot
  | CallOrigin_TargetAccount
  | CallOrigin_SourceAccount;
...
export type DispatchFeePayment =
  | DispatchFeePayment_AtSourceChain
  | DispatchFeePayment_AtTargetChain;
...
export type Type_416 = Type_416_Members | Type_416_Member | Type_416__Phantom;

export interface Type_416_Members {
  __kind: 'Members';
  value: [number, number];
}

export interface Type_416_Member {
  __kind: 'Member';
  value: Uint8Array;
}

export interface Type_416__Phantom {
  __kind: '_Phantom';
}

export type Type_417 = Type_417_Xcm | Type_417_Response;

export interface Type_417_Xcm {
  __kind: 'Xcm';
  value: V1MultiLocation;
}

export interface Type_417_Response {
  __kind: 'Response';
  value: V1MultiLocation;
}
...
export type V0MultiLocation =
  | V0MultiLocation_Null
  | V0MultiLocation_X1
  | V0MultiLocation_X2
  | V0MultiLocation_X3
  | V0MultiLocation_X4
...
export type V0MultiAsset =
  | V0MultiAsset_None
  | V0MultiAsset_All
  | V0MultiAsset_AllFungible
  | V0MultiAsset_AllNonFungible
  | V0MultiAsset_AllAbstractFungible
  | V0MultiAsset_AllAbstractNonFungible
  | V0MultiAsset_AllConcreteFungible
  | V0MultiAsset_AllConcreteNonFungible
  | V0MultiAsset_AbstractFungible
  | V0MultiAsset_AbstractNonFungible
  | V0MultiAsset_ConcreteFungible
  | V0MultiAsset_ConcreteNonFungible;
...
export type Type_426 =
  ...
  | Type_426_ReserveAssetDeposit
  | Type_426_TeleportAsset
...
export type Type_431 =
  | Type_431_WithdrawAsset
  | Type_431_ReserveAssetDeposited
  | Type_431_ReceiveTeleportedAsset
  | Type_431_QueryResponse
  | Type_431_TransferAsset
  | Type_431_TransferReserveAsset
  | Type_431_Transact
  | Type_431_HrmpNewChannelOpenRequest
  | Type_431_HrmpChannelAccepted
  | Type_431_HrmpChannelClosing
  | Type_431_RelayedFrom
  | Type_431_SubscribeVersion
  | Type_431_UnsubscribeVersion;
...
export type Type_437 =
  | Type_437_WithdrawAsset
  | Type_437_ReserveAssetDeposited
  | Type_437_ReceiveTeleportedAsset
  | Type_437_QueryResponse
  | Type_437_TransferAsset
  | Type_437_TransferReserveAsset
  | Type_437_Transact
  | Type_437_HrmpNewChannelOpenRequest
  | Type_437_HrmpChannelAccepted
  | Type_437_HrmpChannelClosing
  | Type_437_ClearOrigin
  | Type_437_DescendOrigin
  | Type_437_ReportError
  | Type_437_DepositAsset
  | Type_437_DepositReserveAsset
  | Type_437_ExchangeAsset
  | Type_437_InitiateReserveWithdraw
  | Type_437_InitiateTeleport
  | Type_437_QueryHolding
  | Type_437_BuyExecution
  | Type_437_RefundSurplus
  | Type_437_SetErrorHandler
  | Type_437_SetAppendix
  | Type_437_ClearError
  | Type_437_ClaimAsset
  | Type_437_Trap
  | Type_437_SubscribeVersion
  | Type_437_UnsubscribeVersion;
...
export type V0Order =
  | V0Order_Null
  | V0Order_DepositAsset
  | V0Order_DepositReserveAsset
  | V0Order_ExchangeAsset
  | V0Order_InitiateReserveWithdraw
  | V0Order_InitiateTeleport
  | V0Order_QueryHolding
  | V0Order_BuyExecution;
...
export type V0OriginKind =
  | V0OriginKind_Native
  | V0OriginKind_SovereignAccount
  | V0OriginKind_Superuser
  | V0OriginKind_Xcm;
...
export type V1Order =
  | V1Order_Noop
  | V1Order_DepositAsset
  | V1Order_DepositReserveAsset
  | V1Order_ExchangeAsset
  | V1Order_InitiateReserveWithdraw
  | V1Order_InitiateTeleport
  | V1Order_QueryHolding
  | V1Order_BuyExecution;
...
export type V1MultiAssetFilter =
  | V1MultiAssetFilter_Definite
  | V1MultiAssetFilter_Wild;
...
export type V0Junction =
  | V0Junction_Parent
  | V0Junction_Parachain
  | V0Junction_AccountId32
  | V0Junction_AccountIndex64
  | V0Junction_AccountKey20
  | V0Junction_PalletInstance
  | V0Junction_GeneralIndex
  | V0Junction_GeneralKey
  | V0Junction_OnlyChild
...
export type V1AssetInstance =
  | V1AssetInstance_Undefined
  | V1AssetInstance_Index
  | V1AssetInstance_Array4
  | V1AssetInstance_Array8
  | V1AssetInstance_Array16
  | V1AssetInstance_Array32
...
export type V1Junction =
  ...
  | V1Junction_OnlyChild
  | V1Junction_Plurality;
...
export type V0NetworkId =
  | V0NetworkId_Any
  | V0NetworkId_Named
  | V0NetworkId_Polkadot
  | V0NetworkId_Kusama;
...
export type V0BodyId =
  | V0BodyId_Unit
  | V0BodyId_Named
  | V0BodyId_Index
  | V0BodyId_Executive
  | V0BodyId_Technical
  | V0BodyId_Legislative
  | V0BodyId_Judicial;
...
export type V0BodyPart =
  | V0BodyPart_Voice
  | V0BodyPart_Members
  | V0BodyPart_Fraction
  | V0BodyPart_AtLeastProportion
  | V0BodyPart_MoreThanProportion;
...
export type V1WildFungibility =
  | V1WildFungibility_Fungible
  | V1WildFungibility_NonFungible;
