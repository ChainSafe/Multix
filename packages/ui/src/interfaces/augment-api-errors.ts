...
declare module '@polkadot/api-base/types/errors' {
  interface AugmentedErrors<ApiType extends ApiTypes> {
    assignedSlots: {
      ...
      MaxPermanentSlotsExceeded: AugmentedError<ApiType>;
      MaxTemporarySlotsExceeded: AugmentedError<ApiType>;
      /**
       * Not a parathread.
       **/
       ...
       **/
      OngoingLeaseExists: AugmentedError<ApiType>;
      /**
       ...
       **/
      SlotAlreadyAssigned: AugmentedError<ApiType>;
      /**
       * Permanent or Temporary slot has not been assigned.
       **/
      SlotNotAssigned: AugmentedError<ApiType>;
      /**
       * Generic error
       **/
