...
declare module '@polkadot/api-base/types/storage' {
  interface AugmentedQueries<ApiType extends ApiTypes> {
    assignedSlots: {
       ...
       **/
      activeTemporarySlotCount: AugmentedQuery<ApiType, () => Observable<u32>, []> &
        QueryableStorageEntry<ApiType, []>
      /**
       * Number of assigned (and active) permanent slots.
       **/
      permanentSlotCount: AugmentedQuery<ApiType, () => Observable<u32>, []> &
        QueryableStorageEntry<ApiType, []>
      /**
       * Assigned permanent slots, with their start lease period, and duration.
       **/
      permanentSlots: AugmentedQuery<
        ApiType,
        (arg: u32 | AnyNumber | Uint8Array) => Observable<Option<ITuple<[u32, u32]>>>,
        [u32]
      > &
       ...
       **/
      temporarySlotCount: AugmentedQuery<ApiType, () => Observable<u32>, []> &
        QueryableStorageEntry<ApiType, []>
      /**
       * Assigned temporary slots.
       **/
      temporarySlots: AugmentedQuery<
        ApiType,
        (
          arg: u32 | AnyNumber | Uint8Array
        ) => Observable<Option<PolkadotRuntimeCommonAssignedSlotsParachainTemporarySlot>>,
        [u32]
      > &
        QueryableStorageEntry<ApiType, [u32]>
      /**
    ...
    auctions: {
       ...
       **/
      auctionCounter: AugmentedQuery<ApiType, () => Observable<u32>, []> &
        QueryableStorageEntry<ApiType, []>
      /**
       ...
       **/
      auctionInfo: AugmentedQuery<ApiType, () => Observable<Option<ITuple<[u32, u32]>>>, []> &
        QueryableStorageEntry<ApiType, []>
      /**
       * Amounts currently reserved in the accounts of the bidders currently winning
       * (sub-)ranges.
       **/
      reservedAmounts: AugmentedQuery<
        ApiType,
        (
          arg:
       ...
       **/
      winning: AugmentedQuery<
        ApiType,
        (
          arg: u32 | AnyNumber | Uint8Array
        ) => Observable<Option<Vec<Option<ITuple<[AccountId32, u32, u128]>>>>>,
        [u32]
      > &
        QueryableStorageEntry<ApiType, [u32]>
      /**
    ...
    beefy: {
       ...
       **/
      authorities: AugmentedQuery<ApiType, () => Observable<Vec<BeefyPrimitivesCryptoPublic>>, []> &
        QueryableStorageEntry<ApiType, []>
      /**
      ...
      nextAuthorities: AugmentedQuery<
        ApiType,
        () => Observable<Vec<BeefyPrimitivesCryptoPublic>>,
        []
      > &
        QueryableStorageEntry<ApiType, []>
      /**
    ...
    claims: {
      claims: AugmentedQuery<
        ApiType,
        (arg: EthereumAddress | string | Uint8Array) => Observable<Option<u128>>,
        [EthereumAddress]
      > &
        QueryableStorageEntry<ApiType, [EthereumAddress]>
      /**
       * Pre-claimed Ethereum accounts, by the Account ID that they are claimed to.
       **/
      preclaims: AugmentedQuery<
        ApiType,
        (arg: AccountId32 | string | Uint8Array) => Observable<Option<EthereumAddress>>,
        [AccountId32]
      > &
        QueryableStorageEntry<ApiType, [AccountId32]>
      /**
      ...
      signing: AugmentedQuery<
        ApiType,
        (
          arg: EthereumAddress | string | Uint8Array
        ) => Observable<Option<PolkadotRuntimeCommonClaimsStatementKind>>,
        [EthereumAddress]
      > &
        QueryableStorageEntry<ApiType, [EthereumAddress]>
      ...
      vesting: AugmentedQuery<
        ...
        (
          arg: EthereumAddress | string | Uint8Array
        ) => Observable<Option<ITuple<[u128, u128, u32]>>>,
        [EthereumAddress]
      > &
        QueryableStorageEntry<ApiType, [EthereumAddress]>
      /**
    ...
    configuration: {
      ...
      pendingConfigs: AugmentedQuery<
        ApiType,
        () => Observable<
          Vec<ITuple<[u32, PolkadotRuntimeParachainsConfigurationHostConfiguration]>>
        >,
        []
      > &
        QueryableStorageEntry<ApiType, []>
    ...
    crowdloan: {
       ...
       **/
      funds: AugmentedQuery<
        ApiType,
        (
          arg: u32 | AnyNumber | Uint8Array
        ) => Observable<Option<PolkadotRuntimeCommonCrowdloanFundInfo>>,
        [u32]
      > &
        QueryableStorageEntry<ApiType, [u32]>
      /**
       ...
       **/
      newRaise: AugmentedQuery<ApiType, () => Observable<Vec<u32>>, []> &
        QueryableStorageEntry<ApiType, []>
      /**
       * Tracker for the next available fund index
       **/
      nextFundIndex: AugmentedQuery<ApiType, () => Observable<u32>, []> &
        QueryableStorageEntry<ApiType, []>
      /**
       * Generic query
       **/
    ...
    gilt: {
      ...
      active: AugmentedQuery<
        ApiType,
        (arg: u32 | AnyNumber | Uint8Array) => Observable<Option<PalletGiltActiveGilt>>,
        [u32]
      > &
        QueryableStorageEntry<ApiType, [u32]>
      /**
       ...
       **/
      activeTotal: AugmentedQuery<ApiType, () => Observable<PalletGiltActiveGiltsTotal>, []> &
        QueryableStorageEntry<ApiType, []>
      /**
       * The queues of bids ready to become gilts. Indexed by duration (in `Period`s).
       **/
      queues: AugmentedQuery<
        ApiType,
        (arg: u32 | AnyNumber | Uint8Array) => Observable<Vec<PalletGiltGiltBid>>,
        [u32]
      > &
        QueryableStorageEntry<ApiType, [u32]>
      /**
       ...
       **/
      queueTotals: AugmentedQuery<ApiType, () => Observable<Vec<ITuple<[u32, u128]>>>, []> &
        QueryableStorageEntry<ApiType, []>
      /**
       * Generic query
       **/
    ...
    hrmp: {
      ...
      hrmpChannelContents: AugmentedQuery<
        ...
        [PolkadotParachainPrimitivesHrmpChannelId]
      > &
        QueryableStorageEntry<ApiType, [PolkadotParachainPrimitivesHrmpChannelId]>
      /**
      ...
      hrmpCloseChannelRequestsList: AugmentedQuery<
        ApiType,
        () => Observable<Vec<PolkadotParachainPrimitivesHrmpChannelId>>,
        []
      > &
        QueryableStorageEntry<ApiType, []>
    ...
    mmrLeaf: {
      ...
      beefyAuthorities: AugmentedQuery<
        ApiType,
        () => Observable<BeefyPrimitivesMmrBeefyAuthoritySet>,
        []
      > &
        QueryableStorageEntry<ApiType, []>
      /**
    ...
    paraInclusion: {
       ...
       **/
      availabilityBitfields: AugmentedQuery<
        ApiType,
        (
          arg: u32 | AnyNumber | Uint8Array
        ) => Observable<Option<PolkadotRuntimeParachainsInclusionAvailabilityBitfieldRecord>>,
        [u32]
      > &
        QueryableStorageEntry<ApiType, [u32]>
      /**
       ...
       **/
      pendingAvailability: AugmentedQuery<
        ApiType,
        (
          arg: u32 | AnyNumber | Uint8Array
        ) => Observable<Option<PolkadotRuntimeParachainsInclusionCandidatePendingAvailability>>,
        [u32]
      > &
        QueryableStorageEntry<ApiType, [u32]>
      /**
       ...
       **/
      pendingAvailabilityCommitments: AugmentedQuery<
        ApiType,
        (
          arg: u32 | AnyNumber | Uint8Array
        ) => Observable<Option<PolkadotPrimitivesV2CandidateCommitments>>,
        [u32]
      > &
        QueryableStorageEntry<ApiType, [u32]>
      /**
    ...
    paraInherent: {
       ...
       **/
      included: AugmentedQuery<ApiType, () => Observable<Option<Null>>, []> &
        QueryableStorageEntry<ApiType, []>
      /**
      ...
      onChainVotes: AugmentedQuery<
        ApiType,
        () => Observable<Option<PolkadotPrimitivesV2ScrapedOnChainVotes>>,
        []
      > &
        QueryableStorageEntry<ApiType, []>
      /**
    ...
    paras: {
       ...
       **/
      parachains: AugmentedQuery<ApiType, () => Observable<Vec<u32>>, []> &
        QueryableStorageEntry<ApiType, []>
      /**
      ...
      paraLifecycles: AugmentedQuery<
        ...
        (
          arg: u32 | AnyNumber | Uint8Array
        ) => Observable<Option<PolkadotRuntimeParachainsParasParaLifecycle>>,
        [u32]
      > &
        QueryableStorageEntry<ApiType, [u32]>
      /**
      ...
      pastCodeMeta: AugmentedQuery<
        ...
        (
          arg: u32 | AnyNumber | Uint8Array
        ) => Observable<PolkadotRuntimeParachainsParasParaPastCodeMeta>,
        [u32]
      > &
        QueryableStorageEntry<ApiType, [u32]>
      /**
      ...
      upgradeGoAheadSignal: AugmentedQuery<
        ...
        (
          arg: u32 | AnyNumber | Uint8Array
        ) => Observable<Option<PolkadotPrimitivesV2UpgradeGoAhead>>,
        [u32]
      > &
        QueryableStorageEntry<ApiType, [u32]>
      /**
    ...
    paraScheduler: {
      ...
      availabilityCores: AugmentedQuery<
        ApiType,
        () => Observable<Vec<Option<PolkadotPrimitivesV2CoreOccupied>>>,
        []
      > &
        QueryableStorageEntry<ApiType, []>
      /**
       ...
       **/
      parathreadClaimIndex: AugmentedQuery<ApiType, () => Observable<Vec<u32>>, []> &
        QueryableStorageEntry<ApiType, []>
      /**
       ...
       **/
      parathreadQueue: AugmentedQuery<
        ApiType,
        () => Observable<PolkadotRuntimeParachainsSchedulerParathreadClaimQueue>,
        []
      > &
        QueryableStorageEntry<ApiType, []>
      /**
       ...
       **/
      scheduled: AugmentedQuery<
        ApiType,
        () => Observable<Vec<PolkadotRuntimeParachainsSchedulerCoreAssignment>>,
        []
      > &
        QueryableStorageEntry<ApiType, []>
      /**
       ...
       **/
      sessionStartBlock: AugmentedQuery<ApiType, () => Observable<u32>, []> &
        QueryableStorageEntry<ApiType, []>
      /**
    ...
    parasDisputes: {
      ...
      disputes: AugmentedQuery<
        ...
        ) => Observable<Option<PolkadotPrimitivesV2DisputeState>>,
        [u32, H256]
      > &
       ...
       **/
      frozen: AugmentedQuery<ApiType, () => Observable<Option<u32>>, []> &
        QueryableStorageEntry<ApiType, []>
      /**
    ...
    paraSessionInfo: {
      ...
      assignmentKeysUnsafe: AugmentedQuery<
        ApiType,
        () => Observable<Vec<PolkadotPrimitivesV2AssignmentAppPublic>>,
        []
      > &
        QueryableStorageEntry<ApiType, []>
      /**
      ...
      sessions: AugmentedQuery<
        ApiType,
        (arg: u32 | AnyNumber | Uint8Array) => Observable<Option<PolkadotPrimitivesV2SessionInfo>>,
        [u32]
      > &
        QueryableStorageEntry<ApiType, [u32]>
      /**
    ...
    parasShared: {
      ...
      activeValidatorKeys: AugmentedQuery<
        ApiType,
        () => Observable<Vec<PolkadotPrimitivesV2ValidatorAppPublic>>,
        []
      > &
        QueryableStorageEntry<ApiType, []>
      /**
    ...
    parasSlashing: {
      ...
      unappliedSlashes: AugmentedQuery<
        ...
        (
          arg1: u32 | AnyNumber | Uint8Array,
          arg2: H256 | string | Uint8Array
        ) => Observable<Option<PolkadotRuntimeParachainsDisputesSlashingPendingSlashes>>,
        [u32, H256]
      > &
        QueryableStorageEntry<ApiType, [u32, H256]>
      /**
    ...
    registrar: {
       ...
       **/
      nextFreeParaId: AugmentedQuery<ApiType, () => Observable<u32>, []> &
        QueryableStorageEntry<ApiType, []>
      /**
      ...
      paras: AugmentedQuery<
        ...
        (
          arg: u32 | AnyNumber | Uint8Array
        ) => Observable<Option<PolkadotRuntimeCommonParasRegistrarParaInfo>>,
        [u32]
      > &
        QueryableStorageEntry<ApiType, [u32]>
      /**
    ...
    session: {
      ...
      nextKeys: AugmentedQuery<
        ApiType,
        (arg: AccountId32 | string | Uint8Array) => Observable<Option<RococoRuntimeSessionKeys>>,
        [AccountId32]
      > &
        QueryableStorageEntry<ApiType, [AccountId32]>
      /**
      ...
      queuedKeys: AugmentedQuery<
        ApiType,
        () => Observable<Vec<ITuple<[AccountId32, RococoRuntimeSessionKeys]>>>,
        []
      > &
        QueryableStorageEntry<ApiType, []>
      /**
    ...
    slots: {
       ...
       **/
      leases: AugmentedQuery<
        ApiType,
        (arg: u32 | AnyNumber | Uint8Array) => Observable<Vec<Option<ITuple<[AccountId32, u128]>>>>,
        [u32]
      > &
        QueryableStorageEntry<ApiType, [u32]>
      /**
    ...
    ump: {
       ...
       **/
      needsDispatch: AugmentedQuery<ApiType, () => Observable<Vec<u32>>, []> &
        QueryableStorageEntry<ApiType, []>
      /**
       ...
       **/
      nextDispatchRoundStartWith: AugmentedQuery<ApiType, () => Observable<Option<u32>>, []> &
        QueryableStorageEntry<ApiType, []>
      /**
       ...
       **/
      relayDispatchQueues: AugmentedQuery<
        ApiType,
       ...
       **/
      relayDispatchQueueSize: AugmentedQuery<
        ApiType,
