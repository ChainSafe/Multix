...
declare module '@polkadot/api-base/types/events' {
  interface AugmentedEvents<ApiType extends ApiTypes> {
    ...
    auctions: {
       ...
       **/
      AuctionStarted: AugmentedEvent<
        ApiType,
        [auctionIndex: u32, leasePeriod: u32, ending: u32],
        { auctionIndex: u32; leasePeriod: u32; ending: u32 }
      >;
      /**
       * A new bid has been accepted as the current winner.
       **/
      BidAccepted: AugmentedEvent<
        ApiType,
        [
          bidder: AccountId32,
          paraId: u32,
       ...
       **/
      ReserveConfiscated: AugmentedEvent<
        ApiType,
        [paraId: u32, leaser: AccountId32, amount: u128],
        { paraId: u32; leaser: AccountId32; amount: u128 }
      >;
      /**
      ...
      Reserved: AugmentedEvent<
        ApiType,
        [bidder: AccountId32, extraReserved: u128, totalAmount: u128],
        { bidder: AccountId32; extraReserved: u128; totalAmount: u128 }
      >;
      /**
      ...
      Unreserved: AugmentedEvent<
        ApiType,
        [bidder: AccountId32, amount: u128],
        { bidder: AccountId32; amount: u128 }
      >;
      /**
       * The winning offset was chosen for an auction. This will map into the `Winning` storage map.
       **/
      WinningOffset: AugmentedEvent<
        ApiType,
        [auctionIndex: u32, blockNumber: u32],
        { auctionIndex: u32; blockNumber: u32 }
      >;
      /**
       * Generic event
    ...
    claims: {
      ...
      Claimed: AugmentedEvent<
        ApiType,
        [who: AccountId32, ethereumAddress: EthereumAddress, amount: u128],
        { who: AccountId32; ethereumAddress: EthereumAddress; amount: u128 }
      >;
      /**
       * Generic event
    ...
    crowdloan: {
       ...
       **/
      Contributed: AugmentedEvent<
        ApiType,
        [who: AccountId32, fundIndex: u32, amount: u128],
        { who: AccountId32; fundIndex: u32; amount: u128 }
      >;
      /**
       ...
       **/
      HandleBidResult: AugmentedEvent<
        ApiType,
        [paraId: u32, result: Result<Null, SpRuntimeDispatchError>],
        { paraId: u32; result: Result<Null, SpRuntimeDispatchError> }
      >;
      /**
       * A memo has been updated.
       **/
      MemoUpdated: AugmentedEvent<
        ApiType,
        [who: AccountId32, paraId: u32, memo: Bytes],
        { who: AccountId32; paraId: u32; memo: Bytes }
      >;
      /**
       ...
       **/
      PartiallyRefunded: AugmentedEvent<
        ApiType,
        [paraId: u32],
        { paraId: u32 }
      >;
    ...
    gilt: {
      ...
      BidPlaced: AugmentedEvent<
        ApiType,
        [who: AccountId32, amount: u128, duration: u32],
        { who: AccountId32; amount: u128; duration: u32 }
      >;
      /**
       * A bid was successfully removed (before being accepted as a gilt).
       **/
      BidRetracted: AugmentedEvent<
        ApiType,
        [who: AccountId32, amount: u128, duration: u32],
        { who: AccountId32; amount: u128; duration: u32 }
      >;
       ...
       **/
      GiltIssued: AugmentedEvent<
        ApiType,
        [index: u32, expiry: u32, who: AccountId32, amount: u128],
        { index: u32; expiry: u32; who: AccountId32; amount: u128 }
      >;
      /**
       * An expired gilt has been thawed.
       **/
      GiltThawed: AugmentedEvent<
        ApiType,
        [
          index: u32,
          who: AccountId32,
    ...
    hrmp: {
      ...
      ChannelClosed: AugmentedEvent<
        ApiType,
        [u32, PolkadotParachainPrimitivesHrmpChannelId]
      >;
      /**
    ...
    paraInclusion: {
       ...
       **/
      CandidateBacked: AugmentedEvent<
        ApiType,
        [PolkadotPrimitivesV2CandidateReceipt, Bytes, u32, u32]
      >;
      /**
       * A candidate was included. `[candidate, head_data]`
       **/
      CandidateIncluded: AugmentedEvent<
        ApiType,
        [PolkadotPrimitivesV2CandidateReceipt, Bytes, u32, u32]
      >;
      /**
       ...
       **/
      CandidateTimedOut: AugmentedEvent<
        ApiType,
        [PolkadotPrimitivesV2CandidateReceipt, Bytes, u32]
      >;
      /**
       * Generic event
       **/
    ...
    parasDisputes: {
       ...
       **/
      DisputeConcluded: AugmentedEvent<
        ApiType,
        [H256, PolkadotRuntimeParachainsDisputesDisputeResult]
      >;
      /**
       * A dispute has been initiated. \[candidate hash, dispute location\]
       **/
      DisputeInitiated: AugmentedEvent<
        ApiType,
        [H256, PolkadotRuntimeParachainsDisputesDisputeLocation]
      >;
      /**
    ...
    ump: {
      ...
      OverweightEnqueued: AugmentedEvent<
        ApiType,
        [u32, U8aFixed, u64, SpWeightsWeightV2Weight]
      >;
      /**
      ...
      WeightExhausted: AugmentedEvent<
        ApiType,
        [U8aFixed, SpWeightsWeightV2Weight, SpWeightsWeightV2Weight]
      >;
      /**
       * Generic event
       **/
