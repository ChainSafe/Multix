...
declare module '@polkadot/api-base/types/submittable' {
  interface AugmentedSubmittables<ApiType extends ApiTypes> {
    assignedSlots: {
       ...
       **/
      assignPermParachainSlot: AugmentedSubmittable<
       ...
       **/
      assignTempParachainSlot: AugmentedSubmittable<
        (
        ...
        [u32, PolkadotRuntimeCommonAssignedSlotsSlotLeasePeriodStart]
      >
      /**
       * Unassign a permanent or temporary parachain slot
       **/
      unassignParachainSlot: AugmentedSubmittable<
        (id: u32 | AnyNumber | Uint8Array) => SubmittableExtrinsic<ApiType>,
        [u32]
      >
      /**
    ...
    auctions: {
      ...
      bid: AugmentedSubmittable<
        (
          para: Compact<u32> | AnyNumber | Uint8Array,
          auctionIndex: Compact<u32> | AnyNumber | Uint8Array,
          firstSlot: Compact<u32> | AnyNumber | Uint8Array,
          lastSlot: Compact<u32> | AnyNumber | Uint8Array,
          amount: Compact<u128> | AnyNumber | Uint8Array
        ) => SubmittableExtrinsic<ApiType>,
        [Compact<u32>, Compact<u32>, Compact<u32>, Compact<u32>, Compact<u128>]
      >
      /**
       ...
       **/
      newAuction: AugmentedSubmittable<
        (
          duration: Compact<u32> | AnyNumber | Uint8Array,
          leasePeriodIndex: Compact<u32> | AnyNumber | Uint8Array
        ) => SubmittableExtrinsic<ApiType>,
    ...
    claims: {
      ...
      claim: AugmentedSubmittable<
        (
          ...
          ethereumSignature: PolkadotRuntimeCommonClaimsEcdsaSignature | string | Uint8Array
        ) => SubmittableExtrinsic<ApiType>,
      ...
      claimAttest: AugmentedSubmittable<
        ...
        [AccountId32, PolkadotRuntimeCommonClaimsEcdsaSignature, Bytes]
      >
      /**
      ...
      mintClaim: AugmentedSubmittable<
        (
          who: EthereumAddress | string | Uint8Array,
      ...
      moveClaim: AugmentedSubmittable<
        (
          old: EthereumAddress | string | Uint8Array,
          updated: EthereumAddress | string | Uint8Array,
          maybePreclaim: Option<AccountId32> | null | Uint8Array | AccountId32 | string
        ) => SubmittableExtrinsic<ApiType>,
        [EthereumAddress, EthereumAddress, Option<AccountId32>]
      >
      /**
       * Generic tx
       **/
    ...
    configuration: {
       ...
       **/
      setChainAvailabilityPeriod: AugmentedSubmittable<
       ...
       **/
      setDisputeConclusionByTimeOutPeriod: AugmentedSubmittable<
        (updated: u32 | AnyNumber | Uint8Array) => SubmittableExtrinsic<ApiType>,
        [u32]
      >
      /**
       ...
       **/
      setDisputeMaxSpamSlots: AugmentedSubmittable<
        (updated: u32 | AnyNumber | Uint8Array) => SubmittableExtrinsic<ApiType>,
        [u32]
      >
      /**
       ...
       **/
      setHrmpMaxParathreadInboundChannels: AugmentedSubmittable<
        (updated: u32 | AnyNumber | Uint8Array) => SubmittableExtrinsic<ApiType>,
        [u32]
      >
      /**
       ...
       **/
      setHrmpMaxParathreadOutboundChannels: AugmentedSubmittable<
        (updated: u32 | AnyNumber | Uint8Array) => SubmittableExtrinsic<ApiType>,
        [u32]
      >
      /**
      ...
      setMaxValidators: AugmentedSubmittable<
        (
          updated: Option<u32> | null | Uint8Array | u32 | AnyNumber
        ) => SubmittableExtrinsic<ApiType>,
        [Option<u32>]
      >
      /**
       ...
       **/
      setParathreadCores: AugmentedSubmittable<
        (updated: u32 | AnyNumber | Uint8Array) => SubmittableExtrinsic<ApiType>,
        [u32]
      >
      /**
       ...
       **/
      setParathreadRetries: AugmentedSubmittable<
        (updated: u32 | AnyNumber | Uint8Array) => SubmittableExtrinsic<ApiType>,
        [u32]
      >
      /**
       ...
       **/
      setPvfCheckingEnabled: AugmentedSubmittable<
        (updated: bool | boolean | Uint8Array) => SubmittableExtrinsic<ApiType>,
        [bool]
      >
      /**
       ...
       **/
      setThreadAvailabilityPeriod: AugmentedSubmittable<
        (updated: u32 | AnyNumber | Uint8Array) => SubmittableExtrinsic<ApiType>,
        [u32]
      >
      /**
       ...
       **/
      setUmpMaxIndividualWeight: AugmentedSubmittable<
        (
          updated:
       ...
       **/
      setUmpServiceTotalWeight: AugmentedSubmittable<
        (
          updated:
            | SpWeightsWeightV2Weight
            | { refTime?: any; proofSize?: any }
    ...
    crowdloan: {
       ...
       **/
      addMemo: AugmentedSubmittable<
        (
          index: u32 | AnyNumber | Uint8Array,
          memo: Bytes | string | Uint8Array
        ) => SubmittableExtrinsic<ApiType>,
        [u32, Bytes]
      >
      /**
      ...
      contributeAll: AugmentedSubmittable<
        ...
        [Compact<u32>, Option<SpRuntimeMultiSignature>]
      >
      /**
      ...
      create: AugmentedSubmittable<
        (
          index: Compact<u32> | AnyNumber | Uint8Array,
          cap: Compact<u128> | AnyNumber | Uint8Array,
          firstPeriod: Compact<u32> | AnyNumber | Uint8Array,
          lastPeriod: Compact<u32> | AnyNumber | Uint8Array,
          end: Compact<u32> | AnyNumber | Uint8Array,
          verifier:
            | Option<SpRuntimeMultiSigner>
            | null
            | Uint8Array
      ...
      dissolve: AugmentedSubmittable<
        (index: Compact<u32> | AnyNumber | Uint8Array) => SubmittableExtrinsic<ApiType>,
        [Compact<u32>]
      >
      /**
    ...
    gilt: {
       ...
       **/
      retractBid: AugmentedSubmittable<
        (
          amount: Compact<u128> | AnyNumber | Uint8Array,
          duration: u32 | AnyNumber | Uint8Array
        ) => SubmittableExtrinsic<ApiType>,
       ...
       * at any one time.
       **/
      setTarget: AugmentedSubmittable<
        (target: Compact<Perquintill> | AnyNumber | Uint8Array) => SubmittableExtrinsic<ApiType>,
        [Compact<Perquintill>]
      >
      /**
    ...
    hrmp: {
      ...
      forceCleanHrmp: AugmentedSubmittable<
        (
          ...
          inbound: u32 | AnyNumber | Uint8Array,
          outbound: u32 | AnyNumber | Uint8Array
        ) => SubmittableExtrinsic<ApiType>,
        [u32, u32, u32]
      >
      /**
      ...
      hrmpCancelOpenRequest: AugmentedSubmittable<
        ...
        [PolkadotParachainPrimitivesHrmpChannelId, u32]
      >
      /**
      ...
      includePvfCheckStatement: AugmentedSubmittable<
        (
          stmt:
            ...
            | string
            | Uint8Array,
          signature: PolkadotPrimitivesV2ValidatorAppSignature | string | Uint8Array
        ) => SubmittableExtrinsic<ApiType>,
        [PolkadotPrimitivesV2PvfCheckStatement, PolkadotPrimitivesV2ValidatorAppSignature]
      >
      /**
    ...
    parasSlashing: {
      reportDisputeLostUnsigned: AugmentedSubmittable<
        ...
        [PolkadotRuntimeParachainsDisputesSlashingDisputeProof, SpSessionMembershipProof]
      >
      /**
       * Generic tx
       **/
    ...
    parasSudoWrapper: {
      ...
      sudoQueueDownwardXcm: AugmentedSubmittable<
        (
          id: u32 | AnyNumber | Uint8Array,
          xcm: XcmVersionedXcm | { V0: any } | { V1: any } | { V2: any } | string | Uint8Array
        ) => SubmittableExtrinsic<ApiType>,
        [u32, XcmVersionedXcm]
      >
      /**
      ...
      sudoScheduleParaInitialize: AugmentedSubmittable<
        (
          ...
          genesis:
            ...
            | { genesisHead?: any; validationCode?: any; parachain?: any }
            | string
            | Uint8Array
        ) => SubmittableExtrinsic<ApiType>,
    ...
    proxy: {
      ...
      addProxy: AugmentedSubmittable<
        ...
        [MultiAddress, RococoRuntimeProxyType, u32]
      >
      /**
      ...
      createPure: AugmentedSubmittable<
        ...
        [RococoRuntimeProxyType, u32, u16]
      >
      /**
      ...
      killPure: AugmentedSubmittable<
        ...
        [MultiAddress, RococoRuntimeProxyType, u16, Compact<u32>, Compact<u32>]
      >
      /**
      ...
      proxy: AugmentedSubmittable<
        ...
        [MultiAddress, Option<RococoRuntimeProxyType>, Call]
      >
      /**
      ...
      proxyAnnounced: AugmentedSubmittable<
        ...
        [MultiAddress, MultiAddress, Option<RococoRuntimeProxyType>, Call]
      >
      /**
    ...
    session: {
      ...
      setKeys: AugmentedSubmittable<
        ...
        [RococoRuntimeSessionKeys, Bytes]
      >
      /**
       * Generic tx
       **/
    ...
    slots: {
       ...
       * The dispatch origin for this call must match `T::ForceOrigin`.
       **/
      clearAllLeases: AugmentedSubmittable<
        (para: u32 | AnyNumber | Uint8Array) => SubmittableExtrinsic<ApiType>,
        [u32]
      >
      /**
       ...
       * The dispatch origin for this call must match `T::ForceOrigin`.
       **/
      forceLease: AugmentedSubmittable<
        (
          para: u32 | AnyNumber | Uint8Array,
          leaser: AccountId32 | string | Uint8Array,
          amount: u128 | AnyNumber | Uint8Array,
          periodBegin: u32 | AnyNumber | Uint8Array,
          periodCount: u32 | AnyNumber | Uint8Array
        ) => SubmittableExtrinsic<ApiType>,
        [u32, AccountId32, u128, u32, u32]
      >
      /**
       ...
       **/
      triggerOnboard: AugmentedSubmittable<
        (para: u32 | AnyNumber | Uint8Array) => SubmittableExtrinsic<ApiType>,
        [u32]
      >
      /**
      ...
      judgeSuspendedCandidate: AugmentedSubmittable<
        (
          who:
            ...
            | string
            | Uint8Array,
          judgement: PalletSocietyJudgement | 'Rebid' | 'Reject' | 'Approve' | number | Uint8Array
        ) => SubmittableExtrinsic<ApiType>,
    ...
    utility: {
      ...
      dispatchAs: AugmentedSubmittable<
        ...
        [RococoRuntimeOriginCaller, Call]
      >
      /**
       * Send a batch of dispatch calls.
