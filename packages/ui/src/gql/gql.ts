...
export function graphql(
  source: 'query MultisigById($account: String!) {\n  accounts(where: {id_eq: $account, isMultisig_eq: true}) {\n    signatories {\n      signatory {\n        id\n      }\n    }\n    threshold\n    id\n  }\n}'
): (typeof documents)['query MultisigById($account: String!) {\n  accounts(where: {id_eq: $account, isMultisig_eq: true}) {\n    signatories {\n      signatory {\n        id\n      }\n    }\n    threshold\n    id\n  }\n}']
/**
 * The graphql function is used to parse GraphQL queries into a document that can be used by GraphQL clients.
 */
export function graphql(
  source: 'subscription MultisigCallsByMultisigId($multisigs: [String!]) {\n  multisigCalls(\n    limit: 10\n    orderBy: timestamp_DESC\n    where: {multisig: {id_in: $multisigs}}\n  ) {\n    blockHash\n    callIndex\n    id\n    timestamp\n  }\n}'
): (typeof documents)['subscription MultisigCallsByMultisigId($multisigs: [String!]) {\n  multisigCalls(\n    limit: 10\n    orderBy: timestamp_DESC\n    where: {multisig: {id_in: $multisigs}}\n  ) {\n    blockHash\n    callIndex\n    id\n    timestamp\n  }\n}']
/**
 * The graphql function is used to parse GraphQL queries into a document that can be used by GraphQL clients.
 */
export function graphql(
  source: 'subscription MultisigsByAccounts($accounts: [String!]) {\n  accounts(\n    where: {AND: {isMultisig_eq: true, signatories_some: {signatory: {id_in: $accounts}}}}\n  ) {\n    id\n    isMultisig\n    isPureProxy\n    threshold\n    signatories {\n      signatory {\n        id\n      }\n    }\n    delegateeFor {\n      id\n      type\n      delegator {\n        id\n        isPureProxy\n      }\n      delegatee {\n        id\n        isPureProxy\n      }\n    }\n  }\n}'
