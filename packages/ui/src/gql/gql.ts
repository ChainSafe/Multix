...
const documents = {
    ...
    "subscription MultisigsByAccounts($accounts: [String!], $watchedAccounts: [String!]) {\n  accounts(\n    where: {id_in: $watchedAccounts, AND: {isMultisig_eq: true, OR: {isPureProxy_eq: true}}, OR: {signatories_some: {signatory: {id_in: $accounts}}}}\n  ) {\n    id\n    isMultisig\n    isPureProxy\n    threshold\n    signatories {\n      signatory {\n        id\n      }\n    }\n    delegateeFor {\n      id\n      type\n      delegator {\n        id\n        isPureProxy\n      }\n      delegatee {\n        id\n        isPureProxy\n      }\n    }\n    delegatorFor {\n      id\n      type\n      delegatee {\n        id\n        isMultisig\n        threshold\n        signatories {\n          signatory {\n            id\n          }\n        }\n      }\n    }\n  }\n}": types.MultisigsByAccountsDocument,
};
 ...
 * The graphql function is used to parse GraphQL queries into a document that can be used by GraphQL clients.
 */
export function graphql(source: "subscription MultisigsByAccounts($accounts: [String!], $watchedAccounts: [String!]) {\n  accounts(\n    where: {id_in: $watchedAccounts, AND: {isMultisig_eq: true, OR: {isPureProxy_eq: true}}, OR: {signatories_some: {signatory: {id_in: $accounts}}}}\n  ) {\n    id\n    isMultisig\n    isPureProxy\n    threshold\n    signatories {\n      signatory {\n        id\n      }\n    }\n    delegateeFor {\n      id\n      type\n      delegator {\n        id\n        isPureProxy\n      }\n      delegatee {\n        id\n        isPureProxy\n      }\n    }\n    delegatorFor {\n      id\n      type\n      delegatee {\n        id\n        isMultisig\n        threshold\n        signatories {\n          signatory {\n            id\n          }\n        }\n      }\n    }\n  }\n}"): (typeof documents)["subscription MultisigsByAccounts($accounts: [String!], $watchedAccounts: [String!]) {\n  accounts(\n    where: {id_in: $watchedAccounts, AND: {isMultisig_eq: true, OR: {isPureProxy_eq: true}}, OR: {signatories_some: {signatory: {id_in: $accounts}}}}\n  ) {\n    id\n    isMultisig\n    isPureProxy\n    threshold\n    signatories {\n      signatory {\n        id\n      }\n    }\n    delegateeFor {\n      id\n      type\n      delegator {\n        id\n        isPureProxy\n      }\n      delegatee {\n        id\n        isPureProxy\n      }\n    }\n    delegatorFor {\n      id\n      type\n      delegatee {\n        id\n        isMultisig\n        threshold\n        signatories {\n          signatory {\n            id\n          }\n        }\n      }\n    }\n  }\n}"];
