 ...
 * The graphql function is used to parse GraphQL queries into a document that can be used by GraphQL clients.
 */
export function graphql(source: "subscription MultisigsByAccounts($accountIds: [String!], $watchedAccountIds: [String!]) {\n  accounts(\n    where: {id_in: $watchedAccountIds, AND: {isMultisig_eq: true, OR: {isPureProxy_eq: true}}, OR: {signatories_some: {signatory: {id_in: $accountIds}}}}\n  ) {\n    address\n    isMultisig\n    isPureProxy\n    threshold\n    signatories {\n      signatory {\n        address\n      }\n    }\n    delegateeFor {\n      id\n      type\n      delegator {\n        address\n        isPureProxy\n      }\n      delegatee {\n        address\n        isPureProxy\n      }\n    }\n    delegatorFor {\n      id\n      type\n      delegatee {\n        address\n        isMultisig\n        threshold\n        signatories {\n          signatory {\n            address\n          }\n        }\n      }\n    }\n  }\n}"): (typeof documents)["subscription MultisigsByAccounts($accountIds: [String!], $watchedAccountIds: [String!]) {\n  accounts(\n    where: {id_in: $watchedAccountIds, AND: {isMultisig_eq: true, OR: {isPureProxy_eq: true}}, OR: {signatories_some: {signatory: {id_in: $accountIds}}}}\n  ) {\n    address\n    isMultisig\n    isPureProxy\n    threshold\n    signatories {\n      signatory {\n        address\n      }\n    }\n    delegateeFor {\n      id\n      type\n      delegator {\n        address\n        isPureProxy\n      }\n      delegatee {\n        address\n        isPureProxy\n      }\n    }\n    delegatorFor {\n      id\n      type\n      delegatee {\n        address\n        isMultisig\n        threshold\n        signatories {\n          signatory {\n            address\n          }\n        }\n      }\n    }\n  }\n}"];
