...
export type WesPplDispatchError = Anonymize<I1ef1l2i5ktcdn>;
type PalletsTypedef = {
    __storage: IStorage;
    __tx: ICalls;
    __event: IEvent;
...
export type WesPplQueries = QueryFromPalletsDef<PalletsTypedef>;
export type WesPplCalls = TxFromPalletsDef<PalletsTypedef>;
export type WesPplEvents = EventsFromPalletsDef<PalletsTypedef>;
export type WesPplErrors = ErrorsFromPalletsDef<PalletsTypedef>;
export type WesPplConstants = ConstFromPalletsDef<PalletsTypedef>;
export type WesPplCallData = Anonymize<Idrssolrvf38li> & {
    value: {
        type: string;
    };
};
export type WesPplWhitelistEntry = PalletKey | ApiKey<IRuntimeCalls> | `query.${NestedKey<PalletsTypedef['__storage']>}` | `tx.${NestedKey<PalletsTypedef['__tx']>}` | `event.${NestedKey<PalletsTypedef['__event']>}` | `error.${NestedKey<PalletsTypedef['__error']>}` | `const.${NestedKey<PalletsTypedef['__const']>}`;
