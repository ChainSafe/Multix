...
type IStorage = {
    System: {
         ...
         */
        Events: StorageDescriptor<[], Anonymize<I1hlvpg2lj4n5s>, false>;
        /**
...
type ICalls = {
    ...
    Utility: {
         ...
         *event is deposited.
         */
        batch: TxDescriptor<Anonymize<I6n9iacva5r3rk>>;
        /**
         ...
         */
        as_derivative: TxDescriptor<Anonymize<I5l2a85l996orr>>;
        /**
         ...
         *- O(C) where C is the number of calls to be batched.
         */
        batch_all: TxDescriptor<Anonymize<I6n9iacva5r3rk>>;
        /**
         ...
         *- O(1).
         */
        dispatch_as: TxDescriptor<Anonymize<I3r22fhs60crah>>;
        /**
         *Send a batch of dispatch calls.
         ...
         *- O(C) where C is the number of calls to be batched.
         */
        force_batch: TxDescriptor<Anonymize<I6n9iacva5r3rk>>;
        /**
         ...
         *The dispatch origin for this call must be _Root_.
         */
        with_weight: TxDescriptor<Anonymize<Iakltmod4pcpa7>>;
    };
    Multisig: {
        /**
         ...
         */
        as_multi_threshold_1: TxDescriptor<Anonymize<Ia51i944an6soh>>;
        /**
         ...
         */
        as_multi: TxDescriptor<Anonymize<Idoenh01titkrj>>;
        /**
         *Register approval for a dispatch to be made from a deterministic composite account if
         *approved by a total of `threshold - 1` of `other_signatories`.
         *
    ...
    Proxy: {
         ...
         */
        proxy: TxDescriptor<Anonymize<I65vcof2homb48>>;
        /**
         ...
         *- `call`: The call to be made by the `real` account.
         */
        proxy_announced: TxDescriptor<Anonymize<Id5vftigd4mtji>>;
    };
    Identity: {
        /**
...
type IRuntimeCalls = {
    ...
    TransactionPaymentCallApi: {
         ...
         */
        query_call_info: RuntimeDescriptor<[call: Anonymize<I4ao9sb94fm3jj>, len: number], Anonymize<I6spmpef2c7svf>>;
        /**
         * Query fee details of a given encoded `Call`.
         */
        query_call_fee_details: RuntimeDescriptor<[call: Anonymize<I4ao9sb94fm3jj>, len: number], Anonymize<Iei2mvq0mjvt81>>;
        /**
    ...
    DryRunApi: {
         ...
         * Dry run call.
         */
        dry_run_call: RuntimeDescriptor<[origin: Anonymize<I48v5riethqckl>, call: Anonymize<I4ao9sb94fm3jj>], Anonymize<I55tccq1hakv9c>>;
        /**
         * Dry run XCM program
         */
        dry_run_xcm: RuntimeDescriptor<[origin_location: XcmVersionedLocation, xcm: XcmVersionedXcm], Anonymize<Ie4781qov6lot1>>;
    };
    /**
...
export type KsmPplDispatchError = Anonymize<Iamndt5i5pec5s>;
type PalletsTypedef = {
    __storage: IStorage;
    __tx: ICalls;
    __event: IEvent;
...
export type KsmPplQueries = QueryFromPalletsDef<PalletsTypedef>;
export type KsmPplCalls = TxFromPalletsDef<PalletsTypedef>;
export type KsmPplEvents = EventsFromPalletsDef<PalletsTypedef>;
export type KsmPplErrors = ErrorsFromPalletsDef<PalletsTypedef>;
export type KsmPplConstants = ConstFromPalletsDef<PalletsTypedef>;
export type KsmPplCallData = Anonymize<I4ao9sb94fm3jj> & {
    value: {
        type: string;
    };
};
export type KsmPplWhitelistEntry = PalletKey | ApiKey<IRuntimeCalls> | `query.${NestedKey<PalletsTypedef['__storage']>}` | `tx.${NestedKey<PalletsTypedef['__tx']>}` | `event.${NestedKey<PalletsTypedef['__event']>}` | `error.${NestedKey<PalletsTypedef['__error']>}` | `const.${NestedKey<PalletsTypedef['__const']>}`;
