...
type IStorage = {
    System: {
         ...
         */
        Events: StorageDescriptor<[], Anonymize<I3753v7nr5bgjb>, false>;
        /**
...
type ICalls = {
    ...
    Scheduler: {
         ...
         */
        schedule: TxDescriptor<Anonymize<I803vl6fdchv9q>>;
        /**
         ...
         */
        schedule_named: TxDescriptor<Anonymize<Ibn9r2340joskh>>;
        /**
         ...
         */
        schedule_after: TxDescriptor<Anonymize<I538550jjb0cn2>>;
        /**
         *Schedule a named task after a delay.
         */
        schedule_named_after: TxDescriptor<Anonymize<I8n8m69uslon4t>>;
        /**
    ...
    Whitelist: {
         ...
         */
        dispatch_whitelisted_call_with_preimage: TxDescriptor<Anonymize<Ia3t3mgu5tdpfj>>;
    };
    Claims: {
        /**
    ...
    Utility: {
         ...
         *event is deposited.
         */
        batch: TxDescriptor<Anonymize<I3gjjd2kmfr3gt>>;
        /**
         ...
         *The dispatch origin for this call must be _Signed_.
         */
        as_derivative: TxDescriptor<Anonymize<I7ldb57uu6q3lg>>;
        /**
         ...
         *- O(1).
         */
        dispatch_as: TxDescriptor<Anonymize<Ib0q6775t6mpca>>;
        /**
         *Send a batch of dispatch calls.
         ...
         *- O(C) where C is the number of calls to be batched.
         */
        force_batch: TxDescriptor<Anonymize<I3gjjd2kmfr3gt>>;
        /**
         ...
         *The dispatch origin for this call must be _Root_.
         */
        with_weight: TxDescriptor<Anonymize<I3a88i85ltnt0b>>;
    };
    Proxy: {
        /**
         ...
         */
        proxy: TxDescriptor<Anonymize<Iet6i9asu73j66>>;
        /**
         ...
         *- `call`: The call to be made by the `real` account.
         */
        proxy_announced: TxDescriptor<Anonymize<Iafe2eojeoea0f>>;
    };
    Multisig: {
        /**
         ...
         */
        as_multi_threshold_1: TxDescriptor<Anonymize<I56o0phba4f7c6>>;
        /**
         ...
         */
        as_multi: TxDescriptor<Anonymize<Ike6sr5hslkoc>>;
        /**
         *Register approval for a dispatch to be made from a deterministic composite account if
         *approved by a total of `threshold - 1` of `other_signatories`.
         *
...
type IEvent = {
    System: {
         ...
         *An extrinsic failed.
         */
        ExtrinsicFailed: PlainDescriptor<Anonymize<Ib63bv3hp3ofab>>;
        /**
         *`:code` was updated.
         */
    ...
    Scheduler: {
         ...
         */
        Dispatched: PlainDescriptor<Anonymize<I70vk5snfd28ir>>;
        /**
    ...
    Whitelist: {
         ...
         */
        WhitelistedCallDispatched: PlainDescriptor<Anonymize<I8tjepigqls9h1>>;
    };
    Claims: {
        /**
    ...
    Utility: {
         ...
         *well as the error.
         */
        BatchInterrupted: PlainDescriptor<Anonymize<I4o71sts6mr1a2>>;
        /**
         ...
         */
        ItemFailed: PlainDescriptor<Anonymize<I850j32jnc5r7s>>;
        /**
         *A call was dispatched.
         */
        DispatchedAs: PlainDescriptor<Anonymize<I7b1ht1dclmvkg>>;
    };
    Proxy: {
        /**
         *A proxy was executed correctly, with the given.
         */
        ProxyExecuted: PlainDescriptor<Anonymize<I7b1ht1dclmvkg>>;
        /**
    ...
    Multisig: {
         ...
         */
        MultisigExecuted: PlainDescriptor<Anonymize<I7ovf48fo06rkb>>;
        /**
    ...
    FastUnstake: {
         ...
         */
        Unstaked: PlainDescriptor<Anonymize<I3hvuij3fte8au>>;
        /**
    ...
    Crowdloan: {
         ...
         */
        HandleBidResult: PlainDescriptor<Anonymize<I72vu1lf8gotkk>>;
        /**
...
type IRuntimeCalls = {
    ...
    BlockBuilder: {
         ...
         * this block or not.
         */
        apply_extrinsic: RuntimeDescriptor<[extrinsic: Binary], Anonymize<I2gp03kpao2rm3>>;
        /**
    ...
    TransactionPaymentCallApi: {
         ...
         */
        query_call_info: RuntimeDescriptor<[call: Anonymize<I84lqest6ohk0p>, len: number], Anonymize<I6spmpef2c7svf>>;
        /**
         * Query fee details of a given encoded `Call`.
         */
        query_call_fee_details: RuntimeDescriptor<[call: Anonymize<I84lqest6ohk0p>, len: number], Anonymize<Iei2mvq0mjvt81>>;
        /**
    ...
    DryRunApi: {
         ...
         * Dry run call.
         */
        dry_run_call: RuntimeDescriptor<[origin: PolkadotRuntimeOriginCaller, call: Anonymize<I84lqest6ohk0p>], Anonymize<I8l4k747fg8qon>>;
        /**
         * Dry run XCM program
         */
        dry_run_xcm: RuntimeDescriptor<[origin_location: XcmVersionedLocation, xcm: XcmVersionedXcm], Anonymize<I3s5165bcnp4qa>>;
    };
    /**
...
export type DotDispatchError = Anonymize<I1ffak8crus5ij>;
type PalletsTypedef = {
    __storage: IStorage;
    __tx: ICalls;
    __event: IEvent;
...
export type DotCallData = Anonymize<I84lqest6ohk0p> & {
    value: {
        type: string;
    };
};
export type DotWhitelistEntry = PalletKey | ApiKey<IRuntimeCalls> | `query.${NestedKey<PalletsTypedef['__storage']>}` | `tx.${NestedKey<PalletsTypedef['__tx']>}` | `event.${NestedKey<PalletsTypedef['__event']>}` | `error.${NestedKey<PalletsTypedef['__error']>}` | `const.${NestedKey<PalletsTypedef['__const']>}`;
