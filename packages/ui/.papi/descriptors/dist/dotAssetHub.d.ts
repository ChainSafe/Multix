...
type IStorage = {
    System: {
         ...
         */
        Events: StorageDescriptor<[], Anonymize<I337ai2btcivaq>, false>;
        /**
...
export type DotAssetHubDispatchError = Anonymize<Icogrvf0inr18b>;
type PalletsTypedef = {
    __storage: IStorage;
    __tx: ICalls;
    __event: IEvent;
...
export type DotAssetHubQueries = QueryFromPalletsDef<PalletsTypedef>;
export type DotAssetHubCalls = TxFromPalletsDef<PalletsTypedef>;
export type DotAssetHubEvents = EventsFromPalletsDef<PalletsTypedef>;
export type DotAssetHubErrors = ErrorsFromPalletsDef<PalletsTypedef>;
export type DotAssetHubConstants = ConstFromPalletsDef<PalletsTypedef>;
export type DotAssetHubCallData = Anonymize<I2g5nrfnsbr9n0> & {
    value: {
        type: string;
    };
};
export type DotAssetHubWhitelistEntry = PalletKey | ApiKey<IRuntimeCalls> | `query.${NestedKey<PalletsTypedef['__storage']>}` | `tx.${NestedKey<PalletsTypedef['__tx']>}` | `event.${NestedKey<PalletsTypedef['__event']>}` | `error.${NestedKey<PalletsTypedef['__error']>}` | `const.${NestedKey<PalletsTypedef['__const']>}`;
