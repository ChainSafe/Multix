...
type IStorage = {
    System: {
         ...
         */
        Events: StorageDescriptor<[], Anonymize<I6oojue2nhp42f>, false>;
        /**
    ...
    Balances: {
         ...
         */
        Holds: StorageDescriptor<[Key: SS58String], Anonymize<Ifosl32ihgoeq6>, false>;
        /**
    ...
    Referenda: {
         ...
         */
        ReferendumInfoFor: StorageDescriptor<[Key: number], Anonymize<I85t6l9pssiov4>, true>;
        /**
    ...
    FellowshipReferenda: {
         ...
         * Information concerning any given referendum.
         */
        ReferendumInfoFor: StorageDescriptor<[Key: number], Anonymize<Icousgkbefm7ke>, true>;
        /**
         * The sorted list of referenda ready to be decided but not yet being decided, ordered by
         * conviction-weighted approvals.
         *
    ...
    Parameters: {
         ...
         * Stored parameters.
         */
        Parameters: StorageDescriptor<[Key: Anonymize<I9h43amtitrqum>], Anonymize<I22o1tjs56dvi2>, true>;
    };
    Claims: {
        /**
    ...
    Scheduler: {
         ...
         */
        Agenda: StorageDescriptor<[Key: number], Anonymize<Ic836nv7r3fq4i>, false>;
        /**
    ...
    Proxy: {
         ...
         */
        Proxies: StorageDescriptor<[Key: SS58String], Anonymize<I3khkuiss7sr1m>, false>;
        /**
    ...
    ElectionProviderMultiPhase: {
         ...
         */
        SignedSubmissionsMap: StorageDescriptor<[Key: number], Anonymize<I84stt310eb6c3>, true>;
        /**
...
type ICalls = {
    ...
    Whitelist: {
         ...
         */
        dispatch_whitelisted_call_with_preimage: TxDescriptor<Anonymize<I2ifddbprs364f>>;
    };
    Parameters: {
        /**
    ...
    Utility: {
         ...
         *event is deposited.
         */
        batch: TxDescriptor<Anonymize<I2jef1c2cnp8oc>>;
        /**
         ...
         *The dispatch origin for this call must be _Signed_.
         */
        as_derivative: TxDescriptor<Anonymize<I3v23e79tnlepm>>;
        /**
         ...
         *- O(C) where C is the number of calls to be batched.
         */
        batch_all: TxDescriptor<Anonymize<I2jef1c2cnp8oc>>;
        /**
         ...
         *- O(1).
         */
        dispatch_as: TxDescriptor<Anonymize<I8b032lvj28v38>>;
        /**
         *Send a batch of dispatch calls.
         ...
         *- O(C) where C is the number of calls to be batched.
         */
        force_batch: TxDescriptor<Anonymize<I2jef1c2cnp8oc>>;
        /**
         ...
         *The dispatch origin for this call must be _Root_.
         */
        with_weight: TxDescriptor<Anonymize<Ib36tv0e89obnf>>;
    };
    Society: {
        /**
    ...
    Recovery: {
         ...
         */
        as_recovered: TxDescriptor<Anonymize<I1bk4tm1i2b3ng>>;
        /**
    ...
    Scheduler: {
         ...
         */
        schedule: TxDescriptor<Anonymize<I86371i6qagoce>>;
        /**
         ...
         */
        schedule_named: TxDescriptor<Anonymize<I5gm0fj8b8qu3g>>;
        /**
         ...
         */
        schedule_after: TxDescriptor<Anonymize<Ib5h8krvbu7gcm>>;
        /**
         *Schedule a named task after a delay.
         */
        schedule_named_after: TxDescriptor<Anonymize<Idunov91dgketn>>;
        /**
    ...
    Proxy: {
         ...
         */
        proxy: TxDescriptor<Anonymize<I8pt1p4aiber0h>>;
        /**
         ...
         *zero.
         */
        add_proxy: TxDescriptor<Anonymize<Ia3sdslbn23eti>>;
        /**
         ...
         */
        remove_proxy: TxDescriptor<Anonymize<Ia3sdslbn23eti>>;
        /**
         ...
         */
        create_pure: TxDescriptor<Anonymize<Ict27q3g3cg78f>>;
        /**
         ...
         */
        kill_pure: TxDescriptor<Anonymize<Ieduhgeucg3h7j>>;
        /**
         ...
         *- `call`: The call to be made by the `real` account.
         */
        proxy_announced: TxDescriptor<Anonymize<I9tfpm16e56og7>>;
    };
    Multisig: {
        /**
         ...
         */
        as_multi_threshold_1: TxDescriptor<Anonymize<Ic11v0sqkv8lho>>;
        /**
         ...
         */
        as_multi: TxDescriptor<Anonymize<I5s3p8q2sfvnav>>;
        /**
         *Register approval for a dispatch to be made from a deterministic composite account if
         *approved by a total of `threshold - 1` of `other_signatories`.
         *
...
type IEvent = {
    System: {
         ...
         *An extrinsic failed.
         */
        ExtrinsicFailed: PlainDescriptor<Anonymize<I64gl0ge4ir4jn>>;
        /**
         *`:code` was updated.
         */
    ...
    Whitelist: {
         ...
         */
        WhitelistedCallDispatched: PlainDescriptor<Anonymize<Ifehsusc6g747o>>;
    };
    Parameters: {
        /**
         *A Parameter was set.
    ...
    Utility: {
         ...
         *well as the error.
         */
        BatchInterrupted: PlainDescriptor<Anonymize<I47k56fn84rojg>>;
        /**
         ...
         */
        ItemFailed: PlainDescriptor<Anonymize<Iase69ms3nbqke>>;
        /**
         *A call was dispatched.
         */
        DispatchedAs: PlainDescriptor<Anonymize<I461t9gdjcm4o5>>;
    };
    Society: {
        /**
    ...
    Scheduler: {
         ...
         */
        Dispatched: PlainDescriptor<Anonymize<Idhmkdhk0gf66d>>;
        /**
    ...
    Proxy: {
         ...
         */
        ProxyExecuted: PlainDescriptor<Anonymize<I461t9gdjcm4o5>>;
        /**
         *A pure account has been created by new proxy with given
         *disambiguation index and proxy type.
         */
        PureCreated: PlainDescriptor<Anonymize<Ia9qkoqqvill5r>>;
        /**
         ...
         *A proxy was added.
         */
        ProxyAdded: PlainDescriptor<Anonymize<Ica4ean4b9ksdn>>;
        /**
         *A proxy was removed.
         */
        ProxyRemoved: PlainDescriptor<Anonymize<Ica4ean4b9ksdn>>;
    };
    Multisig: {
        /**
         ...
         */
        MultisigExecuted: PlainDescriptor<Anonymize<Icbi9ul88saklf>>;
        /**
    ...
    FastUnstake: {
         ...
         */
        Unstaked: PlainDescriptor<Anonymize<Idsn6b9o09ac22>>;
        /**
    ...
    Crowdloan: {
         ...
         */
        HandleBidResult: PlainDescriptor<Anonymize<I5too1knnpqnk1>>;
        /**
...
type IRuntimeCalls = {
    ...
    BlockBuilder: {
         ...
         * this block or not.
         */
        apply_extrinsic: RuntimeDescriptor<[extrinsic: Binary], Anonymize<I7e8tdrv5aklbf>>;
        /**
    ...
    TransactionPaymentCallApi: {
         ...
         */
        query_call_info: RuntimeDescriptor<[call: Anonymize<Ibipt6qfiegcf5>, len: number], Anonymize<I6spmpef2c7svf>>;
        /**
         * Query fee details of a given encoded `Call`.
         */
        query_call_fee_details: RuntimeDescriptor<[call: Anonymize<Ibipt6qfiegcf5>, len: number], Anonymize<Iei2mvq0mjvt81>>;
        /**
    ...
    DryRunApi: {
         ...
         * Dry run call.
         */
        dry_run_call: RuntimeDescriptor<[origin: Anonymize<I575vh6g119dum>, call: Anonymize<Ibipt6qfiegcf5>], Anonymize<Ib5fks2228v743>>;
        /**
         * Dry run XCM program
         */
        dry_run_xcm: RuntimeDescriptor<[origin_location: XcmVersionedLocation, xcm: XcmVersionedXcm], Anonymize<Ib748gt0noucrc>>;
    };
    /**
...
export type KsmDispatchError = Anonymize<I3h7okodr0vdlp>;
type PalletsTypedef = {
    __storage: IStorage;
    __tx: ICalls;
    __event: IEvent;
...
export type KsmCallData = Anonymize<Ibipt6qfiegcf5> & {
    value: {
        type: string;
    };
};
export type KsmWhitelistEntry = PalletKey | ApiKey<IRuntimeCalls> | `query.${NestedKey<PalletsTypedef['__storage']>}` | `tx.${NestedKey<PalletsTypedef['__tx']>}` | `event.${NestedKey<PalletsTypedef['__event']>}` | `error.${NestedKey<PalletsTypedef['__error']>}` | `const.${NestedKey<PalletsTypedef['__const']>}`;
