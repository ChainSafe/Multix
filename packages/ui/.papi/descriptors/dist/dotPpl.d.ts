...
export type DotPplDispatchError = Anonymize<Iamndt5i5pec5s>;
type PalletsTypedef = {
    __storage: IStorage;
    __tx: ICalls;
    __event: IEvent;
...
export type DotPplQueries = QueryFromPalletsDef<PalletsTypedef>;
export type DotPplCalls = TxFromPalletsDef<PalletsTypedef>;
export type DotPplEvents = EventsFromPalletsDef<PalletsTypedef>;
export type DotPplErrors = ErrorsFromPalletsDef<PalletsTypedef>;
export type DotPplConstants = ConstFromPalletsDef<PalletsTypedef>;
export type DotPplCallData = Anonymize<I4ao9sb94fm3jj> & {
    value: {
        type: string;
    };
};
export type DotPplWhitelistEntry = PalletKey | ApiKey<IRuntimeCalls> | `query.${NestedKey<PalletsTypedef['__storage']>}` | `tx.${NestedKey<PalletsTypedef['__tx']>}` | `event.${NestedKey<PalletsTypedef['__event']>}` | `error.${NestedKey<PalletsTypedef['__error']>}` | `const.${NestedKey<PalletsTypedef['__const']>}`;
