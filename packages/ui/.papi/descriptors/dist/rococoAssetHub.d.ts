...
type IStorage = {
    System: {
         ...
         */
        Events: StorageDescriptor<[], Anonymize<Iep6r71alq30pn>, false>;
        /**
    ...
    Balances: {
         ...
         */
        Holds: StorageDescriptor<[Key: SS58String], Anonymize<I1qnkddanljven>, false>;
        /**
    ...
    ToWestendXcmRouter: {
         ...
         */
        DeliveryFeeFactor: StorageDescriptor<[], bigint, false>;
    };
    Assets: {
        /**
         * Details of an asset.
    ...
    AssetsFreezer: {
         ...
         */
        Freezes: StorageDescriptor<Anonymize<I7svnfko10tq2e>, Anonymize<I9bin2jc70qt6q>, false>;
        /**
         * A map that stores the current total frozen balance for every account on a given AssetId.
         */
        FrozenBalances: StorageDescriptor<Anonymize<I7svnfko10tq2e>, bigint, true>;
    };
    ForeignAssetsFreezer: {
        /**
         * A map that stores freezes applied on an account for a given AssetId.
         */
        Freezes: StorageDescriptor<Anonymize<I7rv8d2nr55kkq>, Anonymize<I9bin2jc70qt6q>, false>;
        /**
         * A map that stores the current total frozen balance for every account on a given AssetId.
         */
        FrozenBalances: StorageDescriptor<Anonymize<I7rv8d2nr55kkq>, bigint, true>;
    };
    PoolAssetsFreezer: {
        /**
         * A map that stores freezes applied on an account for a given AssetId.
...
type ICalls = {
    ...
    Utility: {
         ...
         *event is deposited.
         */
        batch: TxDescriptor<Anonymize<I6mahckc73q3cs>>;
        /**
         ...
         */
        as_derivative: TxDescriptor<Anonymize<I8a9e2stm5p30l>>;
        /**
         ...
         *- O(1).
         */
        dispatch_as: TxDescriptor<Anonymize<If6v5itji4rjo>>;
        /**
         *Send a batch of dispatch calls.
         ...
         *- O(C) where C is the number of calls to be batched.
         */
        force_batch: TxDescriptor<Anonymize<I6mahckc73q3cs>>;
        /**
         ...
         *The dispatch origin for this call must be _Root_.
         */
        with_weight: TxDescriptor<Anonymize<I97v4sqr61qvjh>>;
    };
    Multisig: {
        /**
         ...
         */
        as_multi_threshold_1: TxDescriptor<Anonymize<Iep045leqeq26j>>;
        /**
         ...
         */
        as_multi: TxDescriptor<Anonymize<Ifenifpb8c4eua>>;
        /**
         *Register approval for a dispatch to be made from a deterministic composite account if
         *approved by a total of `threshold - 1` of `other_signatories`.
         *
    ...
    Proxy: {
         ...
         */
        proxy: TxDescriptor<Anonymize<I8jssk3qb2ii4c>>;
        /**
         ...
         *- `call`: The call to be made by the `real` account.
         */
        proxy_announced: TxDescriptor<Anonymize<Ia5solf5a3q97l>>;
    };
    Assets: {
        /**
    ...
    AssetConversionMigration: {
         ...
         *Must be signed.
         */
        migrate_to_new_account: TxDescriptor<Anonymize<I8eoqk45hnet27>>;
    };
};
type IEvent = {
    System: {
         ...
         *An extrinsic failed.
         */
        ExtrinsicFailed: PlainDescriptor<Anonymize<Icmnp3seup5048>>;
        /**
         *`:code` was updated.
         */
    ...
    Utility: {
         ...
         *well as the error.
         */
        BatchInterrupted: PlainDescriptor<Anonymize<I3cdmbbljpm4r4>>;
        /**
         ...
         */
        ItemFailed: PlainDescriptor<Anonymize<Ibi2eqcirs7khr>>;
        /**
         *A call was dispatched.
         */
        DispatchedAs: PlainDescriptor<Anonymize<If0ip15ume9htr>>;
    };
    Multisig: {
        /**
         ...
         */
        MultisigExecuted: PlainDescriptor<Anonymize<I7n66lbvia9mpt>>;
        /**
    ...
    Proxy: {
         ...
         */
        ProxyExecuted: PlainDescriptor<Anonymize<If0ip15ume9htr>>;
        /**
    ...
    ForeignAssetsFreezer: {
         ...
         */
        Frozen: PlainDescriptor<Anonymize<I42gee3b9iotl3>>;
        /**
        
         */
        Thawed: PlainDescriptor<Anonymize<I42gee3b9iotl3>>;
    };
    PoolAssetsFreezer: {
        /**
    ...
    AssetConversionMigration: {
         ...
         */
        MigratedToNewAccount: PlainDescriptor<Anonymize<I39hnp3oiidp2i>>;
    };
};
type IError = {
    System: {
...
type IRuntimeCalls = {
    ...
    BlockBuilder: {
         ...
         * this block or not.
         */
        apply_extrinsic: RuntimeDescriptor<[extrinsic: Binary], Anonymize<I1qr7k9oo5fdrg>>;
        /**
    ...
    TransactionPaymentCallApi: {
         ...
         */
        query_call_info: RuntimeDescriptor<[call: Anonymize<I8g3e3pmb9v816>, len: number], Anonymize<I6spmpef2c7svf>>;
        /**
         * Query fee details of a given encoded `Call`.
         */
        query_call_fee_details: RuntimeDescriptor<[call: Anonymize<I8g3e3pmb9v816>, len: number], Anonymize<Iei2mvq0mjvt81>>;
        /**
    ...
    DryRunApi: {
         ...
         * Dry run call.
         */
        dry_run_call: RuntimeDescriptor<[origin: Anonymize<I48v5riethqckl>, call: Anonymize<I8g3e3pmb9v816>], Anonymize<Ifbmf7o7289slt>>;
        /**
         * Dry run XCM program
         */
        dry_run_xcm: RuntimeDescriptor<[origin_location: XcmVersionedLocation, xcm: XcmVersionedXcm], Anonymize<Idmol6r5dudrkc>>;
    };
    /**
...
export type RococoAssetHubDispatchError = Anonymize<Idb44iss70omh4>;
type PalletsTypedef = {
    __storage: IStorage;
    __tx: ICalls;
    __event: IEvent;
...
export type RococoAssetHubQueries = QueryFromPalletsDef<PalletsTypedef>;
export type RococoAssetHubCalls = TxFromPalletsDef<PalletsTypedef>;
export type RococoAssetHubEvents = EventsFromPalletsDef<PalletsTypedef>;
export type RococoAssetHubErrors = ErrorsFromPalletsDef<PalletsTypedef>;
export type RococoAssetHubConstants = ConstFromPalletsDef<PalletsTypedef>;
export type RococoAssetHubCallData = Anonymize<I8g3e3pmb9v816> & {
    value: {
        type: string;
    };
};
export type RococoAssetHubWhitelistEntry = PalletKey | ApiKey<IRuntimeCalls> | `query.${NestedKey<PalletsTypedef['__storage']>}` | `tx.${NestedKey<PalletsTypedef['__tx']>}` | `event.${NestedKey<PalletsTypedef['__event']>}` | `error.${NestedKey<PalletsTypedef['__error']>}` | `const.${NestedKey<PalletsTypedef['__const']>}`;
