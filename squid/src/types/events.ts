...
export class MultisigNewMultisigEvent {
  ...
  /**
     * A new multisig operation has begun.
     */
  get asV9190(): {approving: Uint8Array, multisig: Uint8Array, callHash: Uint8Array} {
    assert(this.isV9190)
...
export class ProxyPureCreatedEvent {
  ...
  /**
     ...
     */
  get isV9300(): boolean {
    return this._chain.getEventHash('Proxy.PureCreated') === '70f97647f913d660994bbf6d1a9a00a2bf96fd3bcf17d035d56676b31e74ef97'
  }
