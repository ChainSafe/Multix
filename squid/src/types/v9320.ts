...
export type Type_265 = Type_265_Relay | Type_265_SiblingParachain

export interface Type_265_Relay {
    __kind: 'Relay'
}

export interface Type_265_SiblingParachain {
