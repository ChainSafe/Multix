...
export const Type_531: sts.Type<Type_531> = sts.closedEnum(() => {
    return  {
        V0: Type_532,
        V1: Type_537,
        V2: sts.array(() => Type_543),
    }
})
...
export const Type_543: sts.Type<Type_543> = sts.closedEnum(() => {
    return  {
        ...
        ReserveAssetDeposited: sts.array(() => V1MultiAsset),
        SetAppendix: sts.array(() => Type_543),
        SetErrorHandler: sts.array(() => Type_543),
        SubscribeVersion: sts.enumStruct({
            queryId: sts.bigint(),
            maxResponseWeight: sts.bigint(),
        }),
...
export const Type_536: sts.Type<Type_536> = sts.struct(() => {
    return  {
        encoded: sts.bytes(),
    }
})
...
export const Type_537: sts.Type<Type_537> = sts.closedEnum(() => {
    return  {
        HrmpChannelAccepted: sts.enumStruct({
            recipient: sts.number(),
        }),
...
export const Type_539: sts.Type<Type_539> = sts.closedEnum(() => {
    return  {
        BuyExecution: sts.enumStruct({
            fees: V1MultiAsset,
            weight: sts.bigint(),
            debt: sts.bigint(),
            haltOnError: sts.boolean(),
            instructions: sts.array(() => Type_537),
        }),
        DepositAsset: sts.enumStruct({
            assets: V1MultiAssetFilter,
            maxAssets: sts.number(),
...
export type Type_539 = Type_539_BuyExecution | Type_539_DepositAsset | Type_539_DepositReserveAsset | Type_539_ExchangeAsset | Type_539_InitiateReserveWithdraw | Type_539_InitiateTeleport | Type_539_Noop | Type_539_QueryHolding
...
export const Type_532: sts.Type<Type_532> = sts.closedEnum(() => {
    return  {
        HrmpChannelAccepted: sts.enumStruct({
            recipient: sts.number(),
        }),
...
export const Type_534: sts.Type<Type_534> = sts.closedEnum(() => {
    return  {
        BuyExecution: sts.enumStruct({
            fees: V0MultiAsset,
            weight: sts.bigint(),
...
export type Type_534 = Type_534_BuyExecution | Type_534_DepositAsset | Type_534_DepositReserveAsset | Type_534_ExchangeAsset | Type_534_InitiateReserveWithdraw | Type_534_InitiateTeleport | Type_534_Null | Type_534_QueryHolding
...
export type Type_532 = Type_532_HrmpChannelAccepted | Type_532_HrmpChannelClosing | Type_532_HrmpNewChannelOpenRequest | Type_532_QueryResponse | Type_532_RelayedFrom | Type_532_ReserveAssetDeposit | Type_532_TeleportAsset | Type_532_Transact | Type_532_TransferAsset | Type_532_TransferReserveAsset | Type_532_WithdrawAsset
...
export type Type_326 = Type_326_Response | Type_326_Xcm
...
export type Type_369 = Type_369_Approve | Type_369_Rebid | Type_369_Reject
...
export const Type_260: sts.Type<Type_260> = sts.struct(() => {
    return  {
        setId: sts.bigint(),
...
export const Type_262: sts.Type<Type_262> = sts.struct(() => {
    return  {
