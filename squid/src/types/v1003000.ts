...
export const Type_439: sts.Type<Type_439> = sts.closedEnum(() => {
    return  {
        V2: sts.array(() => Type_442),
        V3: sts.array(() => Type_446),
        V4: sts.array(() => Type_449),
    }
})
...
export type Type_439 = Type_439_V2 | Type_439_V3 | Type_439_V4
...
export const V7Public = sts.bytes()
...
export type ProxyType = ProxyType_Any | ProxyType_Auction | ProxyType_CancelProxy | ProxyType_Governance | ProxyType_NominationPools | ProxyType_NonTransfer | ProxyType_Society | ProxyType_Spokesperson | ProxyType_Staking
...
export const V7DisputeProof: sts.Type<V7DisputeProof> = sts.struct(() => {
    return  {
        timeSlot: V7DisputesTimeSlot,
        kind: V7SlashingOffenceKind,
        validatorIndex: V7ValidatorIndex,
        validatorId: V7Public,
    }
})

export const V7ValidatorIndex = sts.number()

export const V7SlashingOffenceKind: sts.Type<V7SlashingOffenceKind> = sts.closedEnum(() => {
    return  {
...
export type V7SlashingOffenceKind = V7SlashingOffenceKind_AgainstValid | V7SlashingOffenceKind_ForInvalid

export interface V7SlashingOffenceKind_AgainstValid {
    __kind: 'AgainstValid'
}

export interface V7SlashingOffenceKind_ForInvalid {
    __kind: 'ForInvalid'
}

export const V7DisputesTimeSlot: sts.Type<V7DisputesTimeSlot> = sts.struct(() => {
    return  {
...
export interface V7DisputesTimeSlot {
    sessionIndex: number
    candidateHash: CandidateHash
}
...
export interface V7DisputeProof {
    timeSlot: V7DisputesTimeSlot
    kind: V7SlashingOffenceKind
    validatorIndex: V7ValidatorIndex
    validatorId: V7Public
...
export type V7ValidatorIndex = number
...
export const V7Signature = sts.bytes()

export const V7PvfCheckStatement: sts.Type<V7PvfCheckStatement> = sts.struct(() => {
    return  {
        accept: sts.boolean(),
...
export interface V7PvfCheckStatement {
    accept: boolean
    subject: ValidationCodeHash
    sessionIndex: number
    validatorIndex: V7ValidatorIndex
...
export type RuntimeParameters = RuntimeParameters_Inflation
...
export const V7InherentData: sts.Type<V7InherentData> = sts.struct(() => {
    return  {
        bitfields: sts.array(() => V7UncheckedSigned),
        backedCandidates: sts.array(() => V7BackedCandidate),
        disputes: sts.array(() => V7DisputeStatementSet),
        parentHeader: Header,
    }
})
...
export const V7DisputeStatementSet: sts.Type<V7DisputeStatementSet> = sts.struct(() => {
    return  {
        candidateHash: CandidateHash,
        session: sts.number(),
        statements: sts.array(() => sts.tuple(() => [V7DisputeStatement, V7ValidatorIndex, V7Signature])),
    }
})

export const V7DisputeStatement: sts.Type<V7DisputeStatement> = sts.closedEnum(() => {
    return  {
        Invalid: V7InvalidDisputeStatementKind,
        Valid: V7ValidDisputeStatementKind,
    }
})

export const V7ValidDisputeStatementKind: sts.Type<V7ValidDisputeStatementKind> = sts.closedEnum(() => {
    return  {
...
export type V7ValidDisputeStatementKind = V7ValidDisputeStatementKind_ApprovalChecking | V7ValidDisputeStatementKind_ApprovalCheckingMultipleCandidates | V7ValidDisputeStatementKind_BackingSeconded | V7ValidDisputeStatementKind_BackingValid | V7ValidDisputeStatementKind_Explicit

export interface V7ValidDisputeStatementKind_ApprovalChecking {
    __kind: 'ApprovalChecking'
}

export interface V7ValidDisputeStatementKind_ApprovalCheckingMultipleCandidates {
    __kind: 'ApprovalCheckingMultipleCandidates'
    value: CandidateHash[]
}

export interface V7ValidDisputeStatementKind_BackingSeconded {
    __kind: 'BackingSeconded'
    value: H256
}

export interface V7ValidDisputeStatementKind_BackingValid {
    __kind: 'BackingValid'
    value: H256
}

export interface V7ValidDisputeStatementKind_Explicit {
    __kind: 'Explicit'
}

export const V7InvalidDisputeStatementKind: sts.Type<V7InvalidDisputeStatementKind> = sts.closedEnum(() => {
    return  {
        Explicit: sts.unit(),
    }
})

export type V7InvalidDisputeStatementKind = V7InvalidDisputeStatementKind_Explicit

export interface V7InvalidDisputeStatementKind_Explicit {
    __kind: 'Explicit'
}

export type V7DisputeStatement = V7DisputeStatement_Invalid | V7DisputeStatement_Valid

export interface V7DisputeStatement_Invalid {
    __kind: 'Invalid'
    value: V7InvalidDisputeStatementKind
}

export interface V7DisputeStatement_Valid {
    __kind: 'Valid'
    value: V7ValidDisputeStatementKind
}

export interface V7DisputeStatementSet {
    candidateHash: CandidateHash
    session: number
    statements: [V7DisputeStatement, V7ValidatorIndex, V7Signature][]
}

export const V7BackedCandidate: sts.Type<V7BackedCandidate> = sts.struct(() => {
    return  {
        candidate: V7CommittedCandidateReceipt,
        validityVotes: sts.array(() => V7ValidityAttestation),
        validatorIndices: sts.bitseq(),
    }
})

export const V7ValidityAttestation: sts.Type<V7ValidityAttestation> = sts.closedEnum(() => {
    return  {
        Explicit: V7Signature,
        Implicit: V7Signature,
    }
})

export type V7ValidityAttestation = V7ValidityAttestation_Explicit | V7ValidityAttestation_Implicit

export interface V7ValidityAttestation_Explicit {
    __kind: 'Explicit'
    value: V7Signature
}

export interface V7ValidityAttestation_Implicit {
    __kind: 'Implicit'
    value: V7Signature
}

export const V7CommittedCandidateReceipt: sts.Type<V7CommittedCandidateReceipt> = sts.struct(() => {
    return  {
        descriptor: V7CandidateDescriptor,
        commitments: V7CandidateCommitments,
    }
})

export const V7CandidateCommitments: sts.Type<V7CandidateCommitments> = sts.struct(() => {
    return  {
...
export interface V7CandidateCommitments {
...
export const V7CandidateDescriptor: sts.Type<V7CandidateDescriptor> = sts.struct(() => {
    return  {
        paraId: Id,
        relayParent: H256,
        collator: sts.bytes(),
...
export interface V7CandidateDescriptor {
    paraId: Id
    relayParent: H256
    collator: Bytes
    persistedValidationDataHash: H256
...
export interface V7BackedCandidate {
    candidate: V7CommittedCandidateReceipt
    validityVotes: V7ValidityAttestation[]
    validatorIndices: BitSequence
}

export const V7UncheckedSigned: sts.Type<V7UncheckedSigned> = sts.struct(() => {
    return  {
        payload: V7AvailabilityBitfield,
        validatorIndex: V7ValidatorIndex,
        signature: V7Signature,
    }
})

export const V7AvailabilityBitfield = sts.bitseq()

export interface V7UncheckedSigned {
    payload: V7AvailabilityBitfield
    validatorIndex: V7ValidatorIndex
    signature: V7Signature
}

export type V7AvailabilityBitfield = BitSequence

export interface V7InherentData {
    bitfields: V7UncheckedSigned[]
    backedCandidates: V7BackedCandidate[]
    disputes: V7DisputeStatementSet[]
    parentHeader: Header
}
...
export const NominationPoolsCall: sts.Type<NominationPoolsCall> = sts.closedEnum(() => {
    return  {
        ...
        set_configs: sts.enumStruct({
            minJoinBond: Type_291,
            minCreateBond: Type_291,
            maxPools: Type_292,
            maxMembers: Type_292,
            maxMembersPerPool: Type_292,
            globalMaxCommission: Type_293,
        }),
        set_metadata: sts.enumStruct({
            poolId: sts.number(),
            metadata: sts.bytes(),
...
export const Type_132: sts.Type<Type_132> = sts.struct(() => {
    return  {
        setId: sts.bigint(),
...
export const Type_139: sts.Type<Type_139> = sts.struct(() => {
    return  {
        roundNumber: sts.bigint(),
        identity: Public,
...
export const ConfigurationCall: sts.Type<ConfigurationCall> = sts.closedEnum(() => {
    return  {
        set_approval_voting_params: sts.enumStruct({
            new: V7ApprovalVotingParams,
        }),
        set_async_backing_params: sts.enumStruct({
            new: V7AsyncBackingParams,
        }),
...
export const V7ExecutorParam: sts.Type<V7ExecutorParam> = sts.closedEnum(() => {
    return  {
        MaxMemoryPages: sts.number(),
        PrecheckingMaxMemory: sts.bigint(),
        PvfExecTimeout: sts.tuple(() => [V7PvfExecKind, sts.bigint()]),
        PvfPrepTimeout: sts.tuple(() => [V7PvfPrepKind, sts.bigint()]),
...
export const V7PvfPrepKind: sts.Type<V7PvfPrepKind> = sts.closedEnum(() => {
    return  {
        Precheck: sts.unit(),
        Prepare: sts.unit(),
    }
...
export type V7PvfPrepKind = V7PvfPrepKind_Precheck | V7PvfPrepKind_Prepare

export interface V7PvfPrepKind_Precheck {
    __kind: 'Precheck'
}

export interface V7PvfPrepKind_Prepare {
    __kind: 'Prepare'
}

export const V7PvfExecKind: sts.Type<V7PvfExecKind> = sts.closedEnum(() => {
    return  {
        Approval: sts.unit(),
        Backing: sts.unit(),
    }
...
export type V7PvfExecKind = V7PvfExecKind_Approval | V7PvfExecKind_Backing

export interface V7PvfExecKind_Approval {
    __kind: 'Approval'
}

export interface V7PvfExecKind_Backing {
    __kind: 'Backing'
}

export type V7ExecutorParam = V7ExecutorParam_MaxMemoryPages | V7ExecutorParam_PrecheckingMaxMemory | V7ExecutorParam_PvfExecTimeout | V7ExecutorParam_PvfPrepTimeout | V7ExecutorParam_StackLogicalMax | V7ExecutorParam_StackNativeMax | V7ExecutorParam_WasmExtBulkMemory

export interface V7ExecutorParam_MaxMemoryPages {
    __kind: 'MaxMemoryPages'
    value: number
}

export interface V7ExecutorParam_PrecheckingMaxMemory {
    __kind: 'PrecheckingMaxMemory'
    value: bigint
}

export interface V7ExecutorParam_PvfExecTimeout {
    __kind: 'PvfExecTimeout'
    value: [V7PvfExecKind, bigint]
}

export interface V7ExecutorParam_PvfPrepTimeout {
    __kind: 'PvfPrepTimeout'
    value: [V7PvfPrepKind, bigint]
}

export interface V7ExecutorParam_StackLogicalMax {
    __kind: 'StackLogicalMax'
    value: number
}

export interface V7ExecutorParam_StackNativeMax {
    __kind: 'StackNativeMax'
    value: number
}

export interface V7ExecutorParam_WasmExtBulkMemory {
    __kind: 'WasmExtBulkMemory'
}

export const V7AsyncBackingParams: sts.Type<V7AsyncBackingParams> = sts.struct(() => {
    return  {
...
export interface V7AsyncBackingParams {
    maxCandidateDepth: number
    allowedAncestryLen: number
}

export const V7ApprovalVotingParams: sts.Type<V7ApprovalVotingParams> = sts.struct(() => {
    return  {
        maxApprovalCoalesceCount: sts.number(),
    }
})

export interface V7ApprovalVotingParams {
