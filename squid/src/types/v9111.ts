...
export const Type_525: sts.Type<Type_525> = sts.closedEnum(() => {
    return  {
        ...
        ReserveAssetDeposited: sts.array(() => V1MultiAsset),
        SetAppendix: sts.array(() => Type_525),
        SetErrorHandler: sts.array(() => Type_525),
        SubscribeVersion: sts.enumStruct({
            queryId: sts.bigint(),
            maxResponseWeight: sts.bigint(),
        }),
...
export const Type_519: sts.Type<Type_519> = sts.closedEnum(() => {
    return  {
        HrmpChannelAccepted: sts.enumStruct({
            recipient: sts.number(),
        }),
...
export const Type_521: sts.Type<Type_521> = sts.closedEnum(() => {
    return  {
        BuyExecution: sts.enumStruct({
            fees: V1MultiAsset,
            weight: sts.bigint(),
            debt: sts.bigint(),
            haltOnError: sts.boolean(),
            instructions: sts.array(() => Type_519),
        }),
        DepositAsset: sts.enumStruct({
            assets: V1MultiAssetFilter,
            maxAssets: sts.number(),
...
export type Type_521 = Type_521_BuyExecution | Type_521_DepositAsset | Type_521_DepositReserveAsset | Type_521_ExchangeAsset | Type_521_InitiateReserveWithdraw | Type_521_InitiateTeleport | Type_521_Noop | Type_521_QueryHolding
...
export const Type_514: sts.Type<Type_514> = sts.closedEnum(() => {
    return  {
        HrmpChannelAccepted: sts.enumStruct({
            recipient: sts.number(),
        }),
...
export const Type_516: sts.Type<Type_516> = sts.closedEnum(() => {
    return  {
        BuyExecution: sts.enumStruct({
            fees: V0MultiAsset,
            weight: sts.bigint(),
...
export type Type_516 = Type_516_BuyExecution | Type_516_DepositAsset | Type_516_DepositReserveAsset | Type_516_ExchangeAsset | Type_516_InitiateReserveWithdraw | Type_516_InitiateTeleport | Type_516_Null | Type_516_QueryHolding
 ...
 * Contains one variant per dispatchable that can be called by an extrinsic.
 */
export type XcmPalletCall = XcmPalletCall_execute | XcmPalletCall_force_default_xcm_version | XcmPalletCall_force_subscribe_version_notify | XcmPalletCall_force_unsubscribe_version_notify | XcmPalletCall_force_xcm_version | XcmPalletCall_reserve_transfer_assets | XcmPalletCall_send | XcmPalletCall_teleport_assets
...
export type Type_355 = Type_355_Approve | Type_355_Rebid | Type_355_Reject
...
export const Type_251: sts.Type<Type_251> = sts.struct(() => {
    return  {
        setId: sts.bigint(),
...
export const Type_258: sts.Type<Type_258> = sts.struct(() => {
    return  {
        roundNumber: sts.bigint(),
        identity: Public,
