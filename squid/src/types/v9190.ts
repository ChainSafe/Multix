...
export const Type_550: sts.Type<Type_550> = sts.closedEnum(() => {
    return  {
        ...
        ReserveAssetDeposited: sts.array(() => V1MultiAsset),
        SetAppendix: sts.array(() => Type_550),
        SetErrorHandler: sts.array(() => Type_550),
        SubscribeVersion: sts.enumStruct({
            queryId: sts.bigint(),
            maxResponseWeight: sts.bigint(),
        }),
...
export const Type_546: sts.Type<Type_546> = sts.closedEnum(() => {
    return  {
        BuyExecution: sts.enumStruct({
            fees: V1MultiAsset,
            weight: sts.bigint(),
            debt: sts.bigint(),
            haltOnError: sts.boolean(),
            instructions: sts.array(() => Type_544),
        }),
        DepositAsset: sts.enumStruct({
            assets: V1MultiAssetFilter,
            maxAssets: sts.number(),
...
export type Type_546 = Type_546_BuyExecution | Type_546_DepositAsset | Type_546_DepositReserveAsset | Type_546_ExchangeAsset | Type_546_InitiateReserveWithdraw | Type_546_InitiateTeleport | Type_546_Noop | Type_546_QueryHolding
...
export type Type_541 = Type_541_BuyExecution | Type_541_DepositAsset | Type_541_DepositReserveAsset | Type_541_ExchangeAsset | Type_541_InitiateReserveWithdraw | Type_541_InitiateTeleport | Type_541_Null | Type_541_QueryHolding
...
export type Type_332 = Type_332_Response | Type_332_Xcm
...
export type Type_330 = Type_330_Member | Type_330_Members | Type_330__Phantom
...
export type Type_247 = Type_247_Noop | Type_247_Remove | Type_247_Set
...
export type Type_246 = Type_246_Noop | Type_246_Remove | Type_246_Set
...
export type Type_375 = Type_375_Approve | Type_375_Rebid | Type_375_Reject
