...
export const Type_529: sts.Type<Type_529> = sts.closedEnum(() => {
    return  {
        V0: Type_530,
        V1: Type_535,
        V2: sts.array(() => Type_541),
    }
})
...
export const Type_541: sts.Type<Type_541> = sts.closedEnum(() => {
    return  {
        ...
        ReserveAssetDeposited: sts.array(() => V1MultiAsset),
        SetAppendix: sts.array(() => Type_541),
        SetErrorHandler: sts.array(() => Type_541),
        SubscribeVersion: sts.enumStruct({
            queryId: sts.bigint(),
            maxResponseWeight: sts.bigint(),
        }),
...
export const Type_537: sts.Type<Type_537> = sts.closedEnum(() => {
    return  {
        BuyExecution: sts.enumStruct({
            ...
            debt: sts.bigint(),
            haltOnError: sts.boolean(),
            instructions: sts.array(() => Type_535),
        }),
        DepositAsset: sts.enumStruct({
            assets: V1MultiAssetFilter,
            maxAssets: sts.number(),
...
export type Type_537 = Type_537_BuyExecution | Type_537_DepositAsset | Type_537_DepositReserveAsset | Type_537_ExchangeAsset | Type_537_InitiateReserveWithdraw | Type_537_InitiateTeleport | Type_537_Noop | Type_537_QueryHolding
...
export const Type_530: sts.Type<Type_530> = sts.closedEnum(() => {
    return  {
        HrmpChannelAccepted: sts.enumStruct({
            recipient: sts.number(),
        }),
...
export type Type_532 = Type_532_BuyExecution | Type_532_DepositAsset | Type_532_DepositReserveAsset | Type_532_ExchangeAsset | Type_532_InitiateReserveWithdraw | Type_532_InitiateTeleport | Type_532_Null | Type_532_QueryHolding
...
export type Type_530 = Type_530_HrmpChannelAccepted | Type_530_HrmpChannelClosing | Type_530_HrmpNewChannelOpenRequest | Type_530_QueryResponse | Type_530_RelayedFrom | Type_530_ReserveAssetDeposit | Type_530_TeleportAsset | Type_530_Transact | Type_530_TransferAsset | Type_530_TransferReserveAsset | Type_530_WithdrawAsset
...
export type Type_324 = Type_324_Response | Type_324_Xcm
...
export type Type_322 = Type_322_Member | Type_322_Members | Type_322__Phantom
...
export type Type_321 = Type_321_Member | Type_321_Members | Type_321__Phantom
...
export type Type_367 = Type_367_Approve | Type_367_Rebid | Type_367_Reject
...
export const Type_265: sts.Type<Type_265> = sts.struct(() => {
    return  {
        roundNumber: sts.bigint(),
        identity: Public,
