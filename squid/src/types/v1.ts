...
export type Type_140 = Type_140_System | Type_140_ParachainSystem | Type_140_RandomnessCollectiveFlip | Type_140_Timestamp | Type_140_Balances | Type_140_Authorship | Type_140_CollatorSelection | Type_140_Session | Type_140_XcmpQueue | Type_140_PolkadotXcm | Type_140_DmpQueue | Type_140_Utility | Type_140_Multisig | Type_140_Proxy | Type_140_Assets | Type_140_Uniques

export interface Type_140_System {
    __kind: 'System'
    value: SystemCall
}

export interface Type_140_ParachainSystem {
    __kind: 'ParachainSystem'
    value: ParachainSystemCall
}

export interface Type_140_RandomnessCollectiveFlip {
    __kind: 'RandomnessCollectiveFlip'
    value: RandomnessCollectiveFlipCall
}

export interface Type_140_Timestamp {
    __kind: 'Timestamp'
    value: TimestampCall
}

export interface Type_140_Balances {
    __kind: 'Balances'
    value: BalancesCall
}

export interface Type_140_Authorship {
    __kind: 'Authorship'
    value: AuthorshipCall
}

export interface Type_140_CollatorSelection {
    __kind: 'CollatorSelection'
    value: CollatorSelectionCall
}

export interface Type_140_Session {
    __kind: 'Session'
    value: SessionCall
}

export interface Type_140_XcmpQueue {
    __kind: 'XcmpQueue'
    value: XcmpQueueCall
}

export interface Type_140_PolkadotXcm {
    __kind: 'PolkadotXcm'
    value: PolkadotXcmCall
}

export interface Type_140_DmpQueue {
    __kind: 'DmpQueue'
    value: DmpQueueCall
}

export interface Type_140_Utility {
    __kind: 'Utility'
    value: UtilityCall
}

export interface Type_140_Multisig {
    __kind: 'Multisig'
    value: MultisigCall
}

export interface Type_140_Proxy {
    __kind: 'Proxy'
    value: ProxyCall
}

export interface Type_140_Assets {
    __kind: 'Assets'
    value: AssetsCall
}
