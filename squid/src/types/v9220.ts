...
export const Type_561: sts.Type<Type_561> = sts.closedEnum(() => {
    return  {
        ...
        ReserveAssetDeposited: sts.array(() => V1MultiAsset),
        SetAppendix: sts.array(() => Type_561),
        SetErrorHandler: sts.array(() => Type_561),
        SubscribeVersion: sts.enumStruct({
            queryId: sts.bigint(),
            maxResponseWeight: sts.bigint(),
        }),
...
export const Type_555: sts.Type<Type_555> = sts.closedEnum(() => {
    return  {
        HrmpChannelAccepted: sts.enumStruct({
            recipient: sts.number(),
        }),
...
export const Type_557: sts.Type<Type_557> = sts.closedEnum(() => {
    return  {
        BuyExecution: sts.enumStruct({
            ...
            debt: sts.bigint(),
            haltOnError: sts.boolean(),
            instructions: sts.array(() => Type_555),
        }),
        DepositAsset: sts.enumStruct({
            assets: V1MultiAssetFilter,
            maxAssets: sts.number(),
...
export type Type_557 = Type_557_BuyExecution | Type_557_DepositAsset | Type_557_DepositReserveAsset | Type_557_ExchangeAsset | Type_557_InitiateReserveWithdraw | Type_557_InitiateTeleport | Type_557_Noop | Type_557_QueryHolding
...
export const Type_550: sts.Type<Type_550> = sts.closedEnum(() => {
    return  {
        HrmpChannelAccepted: sts.enumStruct({
            recipient: sts.number(),
        }),
...
export type Type_552 = Type_552_BuyExecution | Type_552_DepositAsset | Type_552_DepositReserveAsset | Type_552_ExchangeAsset | Type_552_InitiateReserveWithdraw | Type_552_InitiateTeleport | Type_552_Null | Type_552_QueryHolding
...
export type Type_339 = Type_339_Response | Type_339_Xcm
...
export type Type_336 = Type_336_Member | Type_336_Members | Type_336__Phantom
...
export type Type_382 = Type_382_Approve | Type_382_Rebid | Type_382_Reject
 ...
 * Contains one variant per dispatchable that can be called by an extrinsic.
 */
export type NominationPoolsCall = NominationPoolsCall_bond_extra | NominationPoolsCall_claim_payout | NominationPoolsCall_create | NominationPoolsCall_join | NominationPoolsCall_nominate | NominationPoolsCall_pool_withdraw_unbonded | NominationPoolsCall_set_configs | NominationPoolsCall_set_metadata | NominationPoolsCall_set_state | NominationPoolsCall_unbond | NominationPoolsCall_update_roles | NominationPoolsCall_withdraw_unbonded
