...
export const Type_480: sts.Type<Type_480> = sts.closedEnum(() => {
    return  {
        V2: sts.array(() => Type_483),
        V3: sts.array(() => Type_487),
        V4: sts.array(() => Type_490),
    }
})
...
export interface Type_483_QueryHolding {
    __kind: 'QueryHolding'
    queryId: bigint
    dest: V2MultiLocation
    assets: V2MultiAssetFilter
...
export type Type_480 = Type_480_V2 | Type_480_V3 | Type_480_V4

export interface Type_480_V2 {
    __kind: 'V2'
    value: Type_483[]
}

export interface Type_480_V3 {
    __kind: 'V3'
    value: Type_487[]
}

export interface Type_480_V4 {
    __kind: 'V4'
    value: Type_490[]
}
...
export const NominationPoolsCall: sts.Type<NominationPoolsCall> = sts.closedEnum(() => {
    return  {
        ...
        set_configs: sts.enumStruct({
            ...
            maxPools: Type_338,
            maxMembers: Type_338,
            maxMembersPerPool: Type_338,
            globalMaxCommission: Type_339,
        }),
        set_metadata: sts.enumStruct({
            poolId: sts.number(),
            metadata: sts.bytes(),
...
export type Type_340 = Type_340_Noop | Type_340_Remove | Type_340_Set

export interface Type_340_Noop {
    __kind: 'Noop'
}

export interface Type_340_Remove {
    __kind: 'Remove'
}

export interface Type_340_Set {
    __kind: 'Set'
    value: AccountId32
}
...
export type Type_339 = Type_339_Noop | Type_339_Remove | Type_339_Set

export interface Type_339_Noop {
    __kind: 'Noop'
}

export interface Type_339_Remove {
    __kind: 'Remove'
}

export interface Type_339_Set {
    __kind: 'Set'
    value: Perbill
}
