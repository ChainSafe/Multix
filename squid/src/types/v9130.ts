...
export const Type_536: sts.Type<Type_536> = sts.closedEnum(() => {
    return  {
        ...
        ReserveAssetDeposited: sts.array(() => V1MultiAsset),
        SetAppendix: sts.array(() => Type_536),
        SetErrorHandler: sts.array(() => Type_536),
        SubscribeVersion: sts.enumStruct({
            queryId: sts.bigint(),
            maxResponseWeight: sts.bigint(),
        }),
...
export const Type_532: sts.Type<Type_532> = sts.closedEnum(() => {
    return  {
        BuyExecution: sts.enumStruct({
            ...
            debt: sts.bigint(),
            haltOnError: sts.boolean(),
            instructions: sts.array(() => Type_530),
        }),
        DepositAsset: sts.enumStruct({
            assets: V1MultiAssetFilter,
            maxAssets: sts.number(),
...
export type Type_532 = Type_532_BuyExecution | Type_532_DepositAsset | Type_532_DepositReserveAsset | Type_532_ExchangeAsset | Type_532_InitiateReserveWithdraw | Type_532_InitiateTeleport | Type_532_Noop | Type_532_QueryHolding
...
export const Type_527: sts.Type<Type_527> = sts.closedEnum(() => {
    return  {
        BuyExecution: sts.enumStruct({
            fees: V0MultiAsset,
            weight: sts.bigint(),
...
export type Type_527 = Type_527_BuyExecution | Type_527_DepositAsset | Type_527_DepositReserveAsset | Type_527_ExchangeAsset | Type_527_InitiateReserveWithdraw | Type_527_InitiateTeleport | Type_527_Null | Type_527_QueryHolding
...
export type Type_322 = Type_322_Response | Type_322_Xcm
...
export type Type_320 = Type_320_Member | Type_320_Members | Type_320__Phantom
...
export type Type_365 = Type_365_Approve | Type_365_Rebid | Type_365_Reject
...
export const Type_254: sts.Type<Type_254> = sts.struct(() => {
    return  {
        setId: sts.bigint(),
