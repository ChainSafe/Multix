...
export const Type_440: sts.Type<Type_440> = sts.closedEnum(() => {
    return  {
        V2: sts.array(() => Type_443),
        V3: sts.array(() => Type_447),
    }
})
...
export type Type_150 = Type_150_Member | Type_150_Members | Type_150__Phantom
...
export type Type_102 = Type_102_Noop | Type_102_Remove | Type_102_Set
...
export type Type_220 = Type_220_Approve | Type_220_Rebid | Type_220_Reject
...
export const Type_111: sts.Type<Type_111> = sts.struct(() => {
    return  {
        setId: sts.bigint(),
...
export const Type_119: sts.Type<Type_119> = sts.struct(() => {
    return  {
        roundNumber: sts.bigint(),
        identity: Public,
...
export type Type_143 = Type_143_Split | Type_143_SplitAbstain | Type_143_Standard
...
export type Type_145 = Type_145_Locked1x | Type_145_Locked2x | Type_145_Locked3x | Type_145_Locked4x | Type_145_Locked5x | Type_145_Locked6x | Type_145_None

export interface Type_145_Locked1x {
    __kind: 'Locked1x'
}

export interface Type_145_Locked2x {
    __kind: 'Locked2x'
}

export interface Type_145_Locked3x {
    __kind: 'Locked3x'
}

export interface Type_145_Locked4x {
    __kind: 'Locked4x'
}

export interface Type_145_Locked5x {
    __kind: 'Locked5x'
}

export interface Type_145_Locked6x {
    __kind: 'Locked6x'
}

export interface Type_145_None {
    __kind: 'None'
}
