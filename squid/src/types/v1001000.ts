...
export type Type_449 = Type_449_V2 | Type_449_V3
...
export type Type_159 = Type_159_Response | Type_159_Xcm

export interface Type_159_Response {
    __kind: 'Response'
    value: V3MultiLocation
}

export interface Type_159_Xcm {
    __kind: 'Xcm'
    value: V3MultiLocation
}
...
export type Type_157 = Type_157_Parachain

export interface Type_157_Parachain {
    __kind: 'Parachain'
    value: Id
}
...
export type Type_110 = Type_110_Noop | Type_110_Remove | Type_110_Set
...
export type Type_109 = Type_109_Noop | Type_109_Remove | Type_109_Set
...
export type Type_108 = Type_108_Noop | Type_108_Remove | Type_108_Set
...
export const NominationPoolsCall: sts.Type<NominationPoolsCall> = sts.closedEnum(() => {
    return  {
        ...
        set_configs: sts.enumStruct({
            minJoinBond: Type_326,
            minCreateBond: Type_326,
            maxPools: Type_327,
            maxMembers: Type_327,
            maxMembersPerPool: Type_327,
            globalMaxCommission: Type_328,
        }),
        set_metadata: sts.enumStruct({
            poolId: sts.number(),
            metadata: sts.bytes(),
...
export const Type_133: sts.Type<Type_133> = sts.struct(() => {
    return  {
