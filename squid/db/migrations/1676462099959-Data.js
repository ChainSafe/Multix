module.exports = class Data1676462099959 {
    name = 'Data1676462099959'
    ...
    async up(db) {
        ...
        await db.query(`CREATE TABLE "proxy_account" ("id" character varying NOT NULL, "type" character varying(17), "delay" integer, "delegator_id" character varying, "delegatee_id" character varying, CONSTRAINT "PK_ec6559af2b2f1e64069037b7eef" PRIMARY KEY ("id"))`)
