module.exports = class Data1681394133681 {
    ...
    async up(db) {
        ...
        await db.query(`CREATE TABLE "account" ("id" character varying NOT NULL, "is_pure_proxy" boolean, "is_multisig" boolean, "threshold" integer, CONSTRAINT "PK_54115ee388cdb6d86bb4bf5b2ea" PRIMARY KEY ("id"))`)
