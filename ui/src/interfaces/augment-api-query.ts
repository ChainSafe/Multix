...
declare module '@polkadot/api-base/types/storage' {
  interface AugmentedQueries<ApiType extends ApiTypes> {
    assignedSlots: {
       ...
       **/
      activeTemporarySlotCount: AugmentedQuery<ApiType, () => Observable<u32>, []> & QueryableStorageEntry<ApiType, []>;
      /**
       * Number of assigned (and active) permanent slots.
       **/
      permanentSlotCount: AugmentedQuery<ApiType, () => Observable<u32>, []> & QueryableStorageEntry<ApiType, []>;
      /**
       * Assigned permanent slots, with their start lease period, and duration.
       **/
      permanentSlots: AugmentedQuery<ApiType, (arg: u32 | AnyNumber | Uint8Array) => Observable<Option<ITuple<[u32, u32]>>>, [u32]> & QueryableStorageEntry<ApiType, [u32]>;
      /**
       * Number of assigned temporary slots.
       **/
      temporarySlotCount: AugmentedQuery<ApiType, () => Observable<u32>, []> & QueryableStorageEntry<ApiType, []>;
      /**
       * Assigned temporary slots.
       **/
      temporarySlots: AugmentedQuery<ApiType, (arg: u32 | AnyNumber | Uint8Array) => Observable<Option<PolkadotRuntimeCommonAssignedSlotsParachainTemporarySlot>>, [u32]> & QueryableStorageEntry<ApiType, [u32]>;
      /**
       * Generic query
       **/
    ...
    mmrLeaf: {
       ...
       **/
      beefyAuthorities: AugmentedQuery<ApiType, () => Observable<BeefyPrimitivesMmrBeefyAuthoritySet>, []> & QueryableStorageEntry<ApiType, []>;
      /**
       * Details of next BEEFY authority set.
       * 
       * This storage entry is used as cache for calls to `update_beefy_next_authority_set`.
       **/
      beefyNextAuthorities: AugmentedQuery<ApiType, () => Observable<BeefyPrimitivesMmrBeefyAuthoritySet>, []> & QueryableStorageEntry<ApiType, []>;
      /**
       * Generic query
       **/
      [key: string]: QueryableStorageEntry<ApiType>;
