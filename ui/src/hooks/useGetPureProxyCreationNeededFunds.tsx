...
export const useGetPureProxyCreationNeededFunds = () => {
    ...
    useEffect(() => {
        ...
        // console.log('reserved Pure Creation', formatBnBalance(reserved, chainInfo.tokenDecimals, { tokenSymbol: chainInfo?.tokenSymbol, numberAfterComma: 3 }))
        setMin(reserved)
